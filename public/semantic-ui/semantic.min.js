...
!(function(e, t, n, i) {
  (e.site = (e.fn.site = function(o) {
    ...
    return (a = {
      ...
      fix: {
        console: function() {
          a.debug('Normalizing window.console'), (console !== i &&
            console.log !== i) ||
            (a.verbose(
              'Console not available, normalizing events'
            ), a.disable.console()), ('undefined' != typeof console.group &&
            'undefined' != typeof console.groupEnd &&
            'undefined' != typeof console.groupCollapsed) ||
            (a.verbose(
              'Console group not available, normalizing events'
            ), (t.console.group = function() {}), (t.console.groupEnd = function() {}), (t.console.groupCollapsed = function() {})), 'undefined' ==
            typeof console.markTimeline &&
            (a.verbose(
        ...
        requestAnimationFrame: function() {
          a.debug(
            'Normalizing requestAnimationFrame'
      ...
      change: {
        setting: function(t, n, o, r) {
          (o = 'string' == typeof o
            ? 'all' === o ? f.modules : [o]
            : o || f.modules), (r = r === i || r), e.each(o, function(i, o) {
            var s, l = !a.moduleExists(o) || (e.fn[o].settings.namespace || !1);
            a.moduleExists(o) &&
              (a.verbose('Changing default setting', t, n, o), (e.fn[
                o
              ].settings[t] = n), r &&
                l &&
                ((s = e(':data(module-' + l + ')')), s.length > 0 &&
                  (a.verbose('Modifying existing settings', s), s[o](
                    'setting',
                    t,
                    n
                  ))));
        ...
        settings: function(t, n, o) {
          (n = 'string' == typeof n ? [n] : n || f.modules), (o = o === i ||
            o), e.each(n, function(n, i) {
            var r;
            a.moduleExists(i) &&
              (a.verbose('Changing default setting', t, i), e.extend(
                !0,
                e.fn[i].settings,
                t
              ), o &&
                m &&
                ((r = e(':data(module-' + m + ')')), r.length > 0 &&
                  (a.verbose('Modifying existing settings', r), r[i](
                    'setting',
                    t
                  ))));
          });
      ...
      console: function(e) {
        if (e) {
          ...
          a.debug(
            'Disabling console function'
          ), (y.cache.console = t.console), (t.console = {
            clear: function() {},
            error: function() {},
            group: function() {},
      ...
      performance: {
        ...
        display: function() {
          ...
          (s = !1), clearTimeout(
            ...
            n += t['Execution Time'];
          }), (t += ' ' + n + 'ms'), (console.group !== i ||
            console.table !== i) &&
            l.length > 0 &&
            (console.groupCollapsed(t), console.table
              ? console.table(l)
              : e.each(l, function(e, t) {
      ...
      invoke: function(t, n, o) {
        var s, l, c, u = y;
        return (n = n || d), (o = b || o), 'string' == typeof t &&
          u !== i &&
          ((t = t.split(/[\. ]/)), (s = t.length -
            1), e.each(t, function(n, o) {
            var r = n != s
      ...
      : (y !== i && a.destroy(), a.initialize()), r !== i ? r : this;
  })), (e.site.settings = {
    name: 'Site',
    namespace: 'site',
    error: {
  ...
  'use strict';
  (t = 'undefined' != typeof t && t.Math == Math
    ? t
      ...
      (F = {
        initialize: function() {
          F.get.settings(), d
            ...
            : (P !== i && P.invoke('destroy'), F.verbose(
                'Initializing form validation',
                O,
                x
              ), F.bindEvents(), F.set.defaults(), F.instantiate());
        },
        instantiate: function() {
        ...
        refresh: function() {
          F.verbose('Refreshing selector cache'), (m = O.find(
            k.field
          )), (g = O.find(k.group)), (p = O.find(k.message)), (h = O.find(
            k.prompt
          )), (v = O.find(k.submit)), (b = O.find(k.clear)), (y = O.find(
            k.reset
          ));
        },
        submit: function() {
        ...
        bindEvents: function() {
          F.verbose('Attaching form events'), O.on(
            ...
            .on('click' + E, k.clear, F.clear), x.keyboardShortcuts &&
            O.on(
              'keydown' + E,
              k.field,
        ...
        clear: function() {
          m.each(function() {
            ...
            l &&
              (F.verbose('Resetting error on field', i), i.removeClass(
                S.error
              ), o.remove()), s ? (F.verbose('Resetting dropdown value', n, a), n.dropdown('clear')) : r ? t.prop('checked', !1) : (F.verbose('Resetting field value', t, a), t.val(''));
          });
        },
        reset: function() {
          m.each(function() {
            ...
            r !== i &&
              (c &&
                (F.verbose('Resetting error on field', o), o.removeClass(
                  S.error
                ), a.remove()), l
                ? (F.verbose('Resetting dropdown value', n, r), n.dropdown(
                    'restore defaults'
                  ))
                : s
                    ? (F.verbose('Resetting checkbox value', n, r), t.prop(
                        'checked',
                        r
                      ))
          ...
          field: {
            keydown: function(t) {
              ...
              i == s.escape &&
                ...
                a ||
                (j ||
                  (n.one('keyup' + E, F.event.field.keyup), F.submit(), F.debug(
            ...
            blur: function(t) {
              ...
              i.hasClass(S.error)
                ? (F.debug('Revalidating field', n, o), o &&
                    F.validate.field(o))
            ...
            change: function(t) {
              ...
              ('change' == x.on || (i.hasClass(S.error) && x.revalidate)) &&
                (clearTimeout(F.timer), (F.timer = setTimeout(
                  function() {
                    F.debug(
                      'Revalidating field',
                      n,
        ...
        get: {
          ancillaryValue: function(e) {
            return !(!e.type || (!e.value && !F.is.bracketedRule(e))) &&
              (e.value !== i
                ? e.value
          ...
          prompt: function(e, t) {
            ...
            return (c || l) && (i = F.get.field(t.identifier)), l &&
              ...
              ((n = i.closest(k.group).find('label').eq(0)), (o = 1 == n.length
                ? n.text()
                : i.prop('placeholder') ||
                    x.text.unspecifiedField), (s = s.replace(
                '{name}',
                o
              ))), (s = s.replace(
              '{identifier}',
              t.identifier
            )), (s = s.replace('{ruleValue}', r)), e.prompt ||
          ...
          settings: function() {
            if (e.isPlainObject(t)) {
              ...
              a
                ? ((x = e.extend(!0, {}, e.fn.form.settings, u)), (C = e.extend(
                    {},
                    e.fn.form.settings.defaults,
                    t
                  )), F.error(x.error.oldSyntax, D), F.verbose(
                    'Extending settings from legacy parameters',
                    C,
                    x
                  ))
                : (t.fields &&
                    ((n = Object.keys(t.fields)), ('string' ==
                      typeof t.fields[n[0]] ||
              ...
              (x = e.fn.form.settings), (C = e.fn.form.settings.defaults), F.verbose(
                'Using default form validation',
                C,
                x
              );
            (A = x.namespace), (w = x.metadata), (k = x.selector), (S = x.className), (T = x.error), (R = 'module-' +
              A), (E = '.' + A), (P = O.data(R)), F.refresh();
          },
          field: function(t) {
            return F.verbose('Finding field with identifier', t), m.filter(
              '#' + t
            ).length > 0
              ? m.filter('#' + t)
        ...
        has: {
          field: function(e) {
            return F.verbose(
              ...
              e
            ), 'string' != typeof e && F.error(T.identifier, e), m.filter(
              '#' + e
            ).length > 0 ||
        ...
        add: {
          prompt: function(t, n) {
            ...
            (n = 'string' == typeof n ? [n] : n), F.verbose(
              ...
              t
            ), a.addClass(S.error), x.inline &&
              (s || ((r = x.templates.prompt(n)), r.appendTo(a)), r.html(
                n[0]
              ), s
                ? F.verbose(
          ...
          errors: function(e) {
            F.debug('Adding form error messages', e), F.set.error(), p.html(
              x.templates.error(e)
            );
          }
        },
        remove: {
          prompt: function(t) {
            ...
            o.removeClass(S.error), x.inline &&
              a.is(':visible') &&
              (F.verbose('Removing prompt for field', t), x.transition &&
                e.fn.transition !== i &&
                O.transition('is supported')
          ...
          values: function(t) {
            e.isEmptyObject(t) ||
              e.each(t, function(t, n) {
                ...
                u &&
                  (r && s
                    ? (F.verbose('Selecting multiple', n, o), a.checkbox(
                        'uncheck'
                    ...
                    : c
                        ? (F.verbose('Selecting radio value', n, o), o
                            .filter('[value="' + n + '"]')
                            .parent(k.uiCheckbox)
                            .checkbox('check'))
                        : s
                            ? (F.verbose('Setting checkbox value', n, a), n ===
                                !0
                                ? a.checkbox('check')
                                : a.checkbox('uncheck'))
                            : l
        ...
        validate: {
          form: function(e, t) {
            ...
            if (((q = []), F.is.valid())) {
              ...
              (F.debug('Form has errors'), F.set.error(), x.inline ||
                F.add.errors(q), O.data('moduleApi') !== i &&
                e.stopImmediatePropagation(), t !== !0)
            )
          ...
          field: function(t, n) {
            ...
            return t.identifier ||
              (F.debug(
                ...
                o
              ), (t.identifier = o)), a.prop('disabled')
                  ...
                  : t.depends && F.is.empty(r)
                      ...
                      : t.rules !== i &&
                          e.each(t.rules, function(e, n) {
                            F.has.field(o) &&
                              !F.validate.rule(t, n) &&
                              (F.debug('Field is invalid', o, n.type), l.push(
                                F.get.prompt(n, t)
                              ), (s = !1));
                          }), s
              ? (F.remove.prompt(o, l), x.onValid.call(a), !0)
              : ((q = q.concat(l)), F.add.prompt(o, l), x.onInvalid.call(
                  a,
                  l
                ), !1);
          },
        ...
        invoke: function(t, n, a) {
          var r, s, l, c = P;
          return (n = n || f), (a = D || a), 'string' == typeof t &&
            c !== i &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(n, o) {
              var a = n != r
                ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1)
                : t;
    ...
    rules: {
      ...
      regExp: function(t, n) {
        ...
        return o &&
          ((n = o.length >= 2 ? o[1] : n), (i = o.length >= 3
            ? o[2]
      ...
      integer: function(t, n) {
        ...
        return n &&
          ...
          (n.indexOf('..') == -1
            ? s.test(n) && (o = (a = n - 0))
            : ((r = n.split('..', 2)), s.test(r[0]) && (o = r[0] - 0), s.test(
                r[1]
              ) && (a = r[1] - 0))), s.test(t) &&
          (o === i || t >= o) &&
          (a === i || t <= a);
      ...
      is: function(e, t) {
        return (t = 'string' == typeof t
          ? t.toLowerCase()
          : t), (e = 'string' == typeof e ? e.toLowerCase() : e), e == t;
      },
      ...
      not: function(e, t) {
        return (e = 'string' == typeof e
          ? e.toLowerCase()
          : e), (t = 'string' == typeof t ? t.toLowerCase() : t), e != t;
      },
        ...
        if ('string' == typeof t && 0 !== t.length) {
          if (
            ...
            (e.each(l, function(n, i) {
              (o = a[
                i
              ]), o && ((r = { length: e.inArray(t.length, o.length) !== -1, pattern: t.search(o.pattern) !== -1 }), r.length && r.pattern && (s = !0));
            }), !s)
          )
            return !1;
          if (
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    return a.each(function() {
      ...
      (f = {
        initialize: function() {
          f.debug('Initializing', C), f.bind.events(), m.observeChanges &&
            f.observeChanges(), f.instantiate();
        },
        instantiate: function() {
          (T = f), C.data(y, f);
        },
        ...
        observeChanges: function() {
          'MutationObserver' in t &&
            ...
            })), d.observe(S, { childList: !0, subtree: !0 }), f.debug(
        ...
        bind: {
          events: function() {
            f.debug('Binding delegated events'), C.on(
              m.on + b,
              h.trigger,
              f.event.click
            );
        ...
        toggle: function(t) {
          var n = t !== i
            ? 'number' == typeof t ? w.eq(t) : e(t).closest(h.title)
            ...
            s = r && !a,
            l = !r && a;
          f.debug('Toggling visibility of content', n), s || l
            ? m.collapsible
                ? f.close.call(n)
                : f.debug(
        ...
        open: function(t) {
          ...
          return s
            ...
            : (f.debug('Opening accordion content', n), m.onOpening.call(
                o
              ), m.exclusive && f.closeOthers.call(n), n.addClass(
                g.active
              ), o.stop(!0, !0).addClass(g.animating), m.animateChildren &&
                ...
                o
                  ...
                  .addClass(
                    g.active
                  ), f.reset.display.call(this), m.onOpen.call(this), m.onChange.call(this);
              }));
        },
        close: function(t) {
          var n = t !== i
          ...
          (!r && !s) ||
            l ||
            (f.debug('Closing accordion content', o), m.onClosing.call(
              o
            ), n.removeClass(g.active), o
              .stop(!0, !0)
              .addClass(g.animating), m.animateChildren &&
              (e.fn.transition !== i && C.transition('is supported')
                ? o
                    .children()
                    .transition({
        ...
        closeOthers: function(t) {
          ...
          m.closeNested
            ...
            : ((n = l.find(c).not(s)), (o = l
                .find(u)
                .find(c)
                .not(s)), (n = n.not(o)), (a = n.next(k))), n.length > 0 &&
            (f.debug(
              'Exclusive enabled, closing other content',
              n
            ), n.removeClass(g.active), a
              .removeClass(g.animating)
              .stop(!0, !0), m.animateChildren &&
              (e.fn.transition !== i && C.transition('is supported')
                ? a
                    .children()
                    .transition({
        ...
        reset: {
          display: function() {
            f.verbose('Removing inline display from element', this), e(
              this
            ).css('display', ''), '' === e(this).attr('style') &&
              e(this).attr('style', '').removeAttr('style');
          },
          opacity: function() {
            f.verbose('Removing inline opacity from element', this), e(
              this
        ...
        internal: function(t, n) {
          return f.debug('Changing internal', t, n), n === i
            ? f[t]
        ...
        invoke: function(t, n, a) {
          var r, s, l, c = T;
          return (n = n || u), (a = S || a), 'string' == typeof t &&
            c !== i &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(n, o) {
              var a = n != r
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.checkbox = function(o) {
    var a,
      r = e(this),
      s = r.selector || '',
      l = new Date().getTime(),
      ...
      (m = {
        initialize: function() {
          m.verbose(
            ...
            g
          ), m.create.label(), m.bind.events(), m.set.tabbable(), m.hide.input(), m.observeChanges(), m.instantiate(), m.setup();
        },
        instantiate: function() {
        ...
        destroy: function() {
          m.verbose(
            'Destroying module'
          ), m.unbind.events(), m.show.input(), C.removeData(x);
        },
        fix: {
          reference: function() {
            C.is(v.input) &&
              ...
              ), (C = C.closest(v.checkbox)), m.refresh());
          }
        },
        setup: function() {
          m.set.initialLoad(), m.is.indeterminate()
            ? (m.debug('Initial value is indeterminate'), m.indeterminate())
            : m.is.checked()
                ? (m.debug('Initial value is checked'), m.check())
                : (m.debug(
                    'Initial value is unchecked'
        ...
        observeChanges: function() {
          'MutationObserver' in t &&
            ...
            })), r.observe(E, { childList: !0, subtree: !0 }), m.debug(
              'Setting up mutation observer',
              r
            ));
        },
        attachEvents: function(t, n) {
          var i = e(t);
          (n = e.isFunction(m[n]) ? m[n] : m.toggle), i.length > 0
            ? (m.debug('Attaching checkbox events to element', t, n), i.on(
                'click' + y,
                n
              ))
            : m.error(b.notFound);
        ...
        check: function() {
          m.should.allowCheck() &&
            (m.debug(
              'Checking checkbox',
              k
            ), m.set.checked(), m.should.ignoreCallbacks() ||
        ...
        uncheck: function() {
          m.should.allowUncheck() &&
            (m.debug(
              'Unchecking checkbox'
            ), m.set.unchecked(), m.should.ignoreCallbacks() ||
        ...
        indeterminate: function() {
          return m.should.allowIndeterminate()
            ...
            : (m.debug(
              ...
              ), m.set.indeterminate(), void (m.should.ignoreCallbacks() ||
        ...
        determinate: function() {
          return m.should.allowDeterminate()
            ...
            : (m.debug(
              ...
              ), m.set.determinate(), void (m.should.ignoreCallbacks() ||
                (g.onDeterminate.call(S), g.onChange.call(S))));
        },
        enable: function() {
          return m.is.enabled()
            ? void m.debug('Checkbox is already enabled')
            : (m.debug('Enabling checkbox'), m.set.enabled(), g.onEnable.call(
                S
        ...
        disable: function() {
          return m.is.disabled()
            ...
            : (m.debug(
                'Disabling checkbox'
              ), m.set.disabled(), g.onDisable.call(S), void g.onDisabled.call(
                S
              ));
        },
        get: {
        ...
        set: {
          ...
          checked: function() {
            return m.verbose('Setting class to checked'), C.removeClass(
              p.indeterminate
            ).addClass(p.checked), m.is.radio() &&
              m.uncheckOthers(), !m.is.indeterminate() && m.is.checked()
              ? void m.debug(
                  'Input is already checked, skipping input property change'
                )
              : (m.verbose('Setting state to checked', S), k
                  .prop('indeterminate', !1)
                  .prop('checked', !0), void m.trigger.change());
          },
          unchecked: function() {
            return m.verbose('Removing checked class'), C.removeClass(
              p.indeterminate
            ).removeClass(p.checked), !m.is.indeterminate() && m.is.unchecked()
              ? void m.debug('Input is already unchecked')
              : (m.debug('Setting state to unchecked'), k
                  .prop('indeterminate', !1)
                  .prop('checked', !1), void m.trigger.change());
          },
          indeterminate: function() {
            return m.verbose('Setting class to indeterminate'), C.addClass(
              p.indeterminate
            ), m.is.indeterminate()
              ? void m.debug(
                  'Input is already indeterminate, skipping input property change'
                )
              : (m.debug('Setting state to indeterminate'), k.prop(
                  'indeterminate',
                  !0
                ), void m.trigger.change());
          },
          determinate: function() {
            return m.verbose('Removing indeterminate class'), C.removeClass(
              p.indeterminate
            ), m.is.determinate()
              ? void m.debug(
                  'Input is already determinate, skipping input property change'
                )
              : (m.debug('Setting state to determinate'), void k.prop(
                  'indeterminate',
                  !1
                ));
          },
          disabled: function() {
            return m.verbose('Setting class to disabled'), C.addClass(
              p.disabled
            ), m.is.disabled()
              ? void m.debug(
                  'Input is already disabled, skipping input property change'
                )
              : (m.debug('Setting state to disabled'), k.prop(
                  'disabled',
                  'disabled'
                ), void m.trigger.change());
          },
          enabled: function() {
            return m.verbose('Removing disabled class'), C.removeClass(
              p.disabled
            ), m.is.enabled()
              ? void m.debug(
                  'Input is already enabled, skipping input property change'
                )
              : (m.debug('Setting state to enabled'), k.prop(
                  'disabled',
                  !1
                ), void m.trigger.change());
          },
          tabbable: function() {
            m.verbose('Adding tabindex to checkbox'), k.attr('tabindex') ===
              i && k.attr('tabindex', 0);
          }
        },
        remove: {
        ...
        trigger: {
          change: function() {
            ...
            t &&
              (m.verbose('Triggering native change event'), e.initEvent(
                'change',
                !0,
                !1
              ), t.dispatchEvent(e));
        ...
        create: {
          label: function() {
            k.prevAll(v.label).length > 0
              ? (k.prev(v.label).detach().insertAfter(k), m.debug(
                  'Moving existing label',
                  w
                ))
              : m.has.label() ||
                  ((w = e('<label>').insertAfter(k)), m.debug(
                    'Creating label',
                    w
                  ));
          }
        ...
        bind: {
          events: function() {
            m.verbose('Attaching checkbox events'), C.on(
              'click' + y,
              m.event.click
            )
        ...
        invoke: function(t, n, o) {
          var r, s, l, c = R;
          return (n = n || f), (o = E || o), 'string' == typeof t &&
            c !== i &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(n, o) {
              var a = n != r
      ...
      (m = {
          ...
          m.is.dimmer()
            ...
            : ((f = k), (d = m.has.dimmer()
                ? g.dimmerName
                    ...
                    : f.find(p.dimmer)
                : m.create()), m.set.variation());
        },
        initialize: function() {
          m.debug(
            'Initializing dimmer',
            g
          ), m.bind.events(), m.set.dimmable(), m.instantiate();
        },
        instantiate: function() {
        ...
        destroy: function() {
          m.verbose(
            'Destroying previous module',
            d
          ), m.unbind.events(), m.remove.variation(), f.off(y);
        },
        bind: {
          events: function() {
            'hover' == g.on
              ? f.on('mouseenter' + y, m.show).on('mouseleave' + y, m.hide)
              : 'click' == g.on && f.on(w + y, m.toggle), m.is.page() &&
              (m.debug(
                'Setting as a page dimmer',
                f
              ), m.set.pageDimmer()), m.is.closable() &&
              (m.verbose('Adding dimmer close event', d), f.on(
                w + y,
                p.dimmer,
                m.event.click
              ));
        ...
        event: {
          click: function(t) {
            m.verbose('Determining if event occured on dimmer', t), (0 ===
              d.find(t.target).length ||
        ...
        addContent: function(t) {
          var n = e(t);
          m.debug('Add content to dimmer', n), n.parent()[0] !== d[0] &&
            n.detach().appendTo(d);
        },
        create: function() {
          var t = e(g.template.dimmer());
          return g.dimmerName &&
            (m.debug('Creating named dimmer', g.dimmerName), t.addClass(
              g.dimmerName
            )), t.appendTo(f), t;
        },
        show: function(t) {
          (t = e.isFunction(t) ? t : function() {}), m.debug(
            'Showing dimmer',
            d,
            g
        ...
        hide: function(t) {
          (t = e.isFunction(t) ? t : function() {}), m.is.dimmed() ||
            m.is.animating()
            ? (m.debug('Hiding dimmer', d), m.animate.hide(t), g.onHide.call(
                S
              ), g.onChange.call(S))
            : m.debug('Dimmer is not visible');
        },
        toggle: function() {
          m.verbose('Toggling dimmer visibility', d), m.is.dimmed()
            ? m.hide()
            : m.show();
        },
        animate: {
          show: function(t) {
            (t = e.isFunction(t) ? t : function() {}), g.useCSS &&
              e.fn.transition !== i &&
          ...
          hide: function(t) {
            (t = e.isFunction(t) ? t : function() {}), g.useCSS &&
              ...
              : (m.verbose(
                  ...
                  .stop()
                  .fadeOut(m.get.duration(), function() {
        ...
        get: {
          ...
          duration: function() {
            return 'object' == typeof g.duration
              ? m.is.active() ? g.duration.hide : g.duration.show
              : g.duration;
          }
        },
        has: {
        ...
        set: {
          opacity: function(e) {
            var t = d.css('background-color'),
              ...
              i = n && 3 == n.length,
              o = n && 4 == n.length;
            (e = 0 === g.opacity ? 0 : g.opacity || e), i || o
              ? ((n[3] = e + ')'), (t = n.join(',')))
              : (t = 'rgba(0, 0, 0, ' + e + ')'), m.debug(
              'Setting opacity to',
              e
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.dropdown = function(o) {
    var a,
      r = e(this),
      s = e(n),
      l = r.selector || '',
    ...
    return r.each(function(p) {
      ...
      (k = {
        initialize: function() {
          k.debug('Initializing dropdown', S), k.is.alreadySetup()
            ? k.setup.reference()
            : (k.setup.layout(), k.refreshData(), k.save.defaults(), k.restore.selected(), k.create.id(), k.bind.events(), k.observeChanges(), k.instantiate());
        },
        instantiate: function() {
        ...
        destroy: function() {
          k.verbose(
            ...
            I
          ), k.remove.tabbable(), I.off(z).removeData(M), Q.off(z), s.off(
            y
          ), k.disconnect.menuObserver(), k.disconnect.selectObserver();
        },
        observeChanges: function() {
          'MutationObserver' in t &&
            ((C = new MutationObserver(
              k.event.select.mutation
            )), (w = new MutationObserver(k.event.menu.mutation)), k.debug(
              'Setting up mutation observer',
              C,
              w
            ), k.observe.select(), k.observe.menu());
        },
        disconnect: {
        ...
        create: {
          id: function() {
            (x = (Math.random().toString(16) + '000000000').substr(
              2,
              8
            )), (y = '.' + x), k.verbose('Creating unique id for element', x);
          },
          userChoice: function(t) {
            var n, o, a;
            return !!(t = t || k.get.userValues()) &&
              ((t = e.isArray(t) ? t : [t]), e.each(t, function(t, r) {
                k.get.item(r) === !1 &&
                  ((a = S.templates.addition(
                    ...
                    .attr('data-' + P.text, r)
                    .addClass(T.addition)
                    .addClass(T.item)), S.hideAdditions &&
                    o.addClass(T.hidden), (n = n === i
                    ? o
                    : n.add(o)), k.verbose(
          ...
          userLabels: function(t) {
            ...
            n &&
              (k.debug('Adding user labels', n), e.each(n, function(e, t) {
        ...
        select: {
          firstUnfiltered: function() {
            ...
            ), k.remove.selectedItem(), X.not(D.unselectable)
        ...
        setup: {
          ...
          layout: function() {
            I.is('select') &&
              (k.setup.select(), k.setup.returnedObject()), k.has.menu() ||
              k.create.menu(), k.is.search() &&
              !k.has.search() &&
              (k.verbose('Adding search input'), (V = e('<input />')
                .addClass(T.search)
                .prop('autocomplete', 'off')
                .insertBefore(N))), k.is.multiple() &&
              k.is.searchSelection() &&
              !k.has.sizer() &&
              k.create.sizer(), S.allowTab && k.set.tabbable();
          },
          select: function() {
            var t = k.get.selectValues();
            k.debug('Dropdown initialized on a select', t), I.is('select') &&
              (U = I), U.parent(D.dropdown).length > 0
              ? (k.debug(
                  'UI dropdown already exists. Creating dropdown menu only'
                ), (I = U.closest(D.dropdown)), k.has.menu() ||
                  k.create.menu(), (Q = I.children(D.menu)), k.setup.menu(t))
              : (k.debug('Creating entire dropdown from select'), (I = e(
                  '<div />'
                )
                  ...
                  .addClass(T.dropdown)
                  .html(j.dropdown(t))
                  .insertBefore(U)), U.hasClass(T.multiple) &&
                  U.prop('multiple') === !1 &&
                  (k.error(q.missingMultiple), U.prop('multiple', !0)), U.is(
                  '[multiple]'
                ) && k.set.multiple(), U.prop('disabled') &&
                  (k.debug('Disabling dropdown'), I.addClass(
                    T.disabled
                  )), U.removeAttr('class').detach().prependTo(I)), k.refresh();
          },
          menu: function(e) {
          ...
          reference: function() {
            k.debug(
              ...
              D.dropdown
            )), k.refresh(), k.setup.returnedObject(), m &&
              ((J = k), k.invoke(f));
          },
        ...
        refreshSelectors: function() {
          k.verbose('Refreshing selector cache'), (N = I.find(
            D.text
          )), (V = I.find(D.search)), (U = I.find(D.input)), (W = I.find(
            D.icon
          )), (B = I.prev().find(D.text).length > 0
            ? I.prev().find(D.text)
            : I.prev()), (Q = I.children(D.menu)), (X = Q.find(D.item));
        },
        refreshData: function() {
          k.verbose('Refreshing cached metadata'), X.removeData(
            P.text
          ).removeData(P.value);
        },
        clearData: function() {
          k.verbose('Clearing metadata'), X.removeData(P.text).removeData(
            P.value
        ...
        toggle: function() {
          k.verbose('Toggling menu visibility'), k.is.active()
            ? k.hide()
            : k.show();
        },
        show: function(t) {
          if (
            ((t = e.isFunction(t) ? t : function() {}), k.can.show() &&
              !k.is.active())
          ) {
            if (
              (k.debug('Showing dropdown'), !k.has.message() ||
                k.has.maxSelections() ||
                k.has.allResultsFiltered() ||
                k.remove.message(), k.is.allFiltered())
            )
              return !0;
            S.onShow.call(Z) !== !1 &&
              k.animate.show(function() {
                k.can.click() &&
                  k.bind.intent(), k.has.menuSearch() && k.focusSearch(), k.set.visible(), t.call(Z);
              });
          }
        },
        hide: function(t) {
          (t = e.isFunction(t) ? t : function() {}), k.is.active() &&
            (k.debug('Hiding dropdown'), S.onHide.call(Z) !== !1 &&
              k.animate.hide(function() {
                k.remove.visible(), t.call(Z);
              }));
        },
        hideOthers: function() {
          k.verbose('Finding other dropdowns to hide'), r
            .not(I)
        ...
        hideMenu: function() {
          ...
          ), k.remove.active(), k.remove.visible(), Q.transition('hide');
        },
        ...
        bind: {
          events: function() {
            c &&
              k.bind.touchEvents(), k.bind.keyboardEvents(), k.bind.inputEvents(), k.bind.mouseEvents();
          },
          touchEvents: function() {
            k.debug(
              ...
              (k.is.single() &&
                I.on('touchstart' + z, k.event.test.toggle)), Q.on(
              'touchstart' + z,
              D.item,
          ...
          keyboardEvents: function() {
            k.verbose('Binding keyboard events'), I.on(
              'keydown' + z,
              k.event.keydown
            ), k.has.search() &&
              I.on(
          ...
          inputEvents: function() {
            k.verbose('Binding input change events'), I.on(
              'change' + z,
              D.input,
              k.event.change
            );
          ...
          mouseEvents: function() {
            k.verbose('Binding mouse events'), k.is.multiple() &&
              ...
              : ('click' == S.on
                  ...
                  : 'hover' == S.on
                      ...
                      : I.on(S.on + z, k.toggle), I.on(
                  'mousedown' + z,
                  k.event.mousedown
                )
                  .on('mouseup' + z, k.event.mouseup)
                  .on('focus' + z, k.event.focus)
                  .on('blur' + z, k.event.blur)), Q.on(
              'mouseenter' + z,
              D.item,
              k.event.item.mouseenter
            )
          ...
          intent: function() {
            k.verbose('Binding hide intent event to document'), c &&
              s
                .on('touchstart' + y, k.event.test.touch)
                .on('touchmove' + y, k.event.test.touch), s.on(
              'click' + y,
              k.event.test.hide
            );
          }
        ...
        unbind: {
          intent: function() {
            k.verbose('Removing hide intent event from document'), c &&
              s.off('touchstart' + y).off('touchmove' + y), s.off('click' + y);
          }
        },
        filter: function(e) {
          var t = e !== i ? e : k.get.query(),
            n = function() {
              k.is.multiple() &&
                k.filterActive(), k.select.firstUnfiltered(), k.has.allResultsFiltered()
                ? S.onNoResults.call(Z, t)
                    ? S.allowAdditions
                        ? S.hideAdditions &&
                            (k.verbose(
                              'User addition with no menu, setting empty style'
                            ), k.set.empty(), k.hideMenu())
                        : (k.verbose(
                ...
                : (k.remove.empty(), k.remove.message()), S.allowAdditions &&
                k.add.userSuggestion(e), k.is.searchSelection() &&
                k.can.show() &&
        ...
        queryRemote: function(t, n) {
          ...
          I.api('get request') || k.setup.api(), (i = e.extend(
            !0,
            {},
            i,
            S.apiSettings
          ...
          k.has.query() &&
            ((o = []), k.verbose(
              ...
              if ('both' == S.match || 'text' == S.match) {
                if (((t = String(k.get.choiceText(a, !1))), t.search(r) !== -1))
              ...
              if ('both' == S.match || 'value' == S.match) {
                if (((i = String(k.get.choiceValue(a, t))), i.search(r) !== -1))
                  return o.push(this), !0;
            ...
            n
          ), k.remove.filteredItem(), o && X.not(o).addClass(T.filtered);
        },
        ...
        exactSearch: function(e, t) {
          return (e = e.toLowerCase()), (t = t.toLowerCase()), t.indexOf(e) >
            -1;
        },
        ...
        focusSearch: function(e) {
          k.has.search() &&
            !k.is.focusedOnSearch() &&
            (e
              ? (I.off('focus' + z, D.search), V.focus(), I.on(
                  'focus' + z,
                  D.search,
        ...
        event: {
          change: function() {
            K ||
              (k.debug('Input changed, updating selection'), k.set.selected());
          },
          focus: function() {
          ...
          search: {
            focus: function() {
              ($ = !0), k.is.multiple() &&
                k.remove.activeLabel(), S.showOnFocus && k.search();
            },
            blur: function(e) {
              (v = n.activeElement === this), b ||
                Y ||
                v ||
                (S.forceSelection && k.forceSelection(), k.hide()), (b = !1);
            }
          },
          icon: {
            click: function(e) {
          ...
          input: function(e) {
            (k.is.multiple() || k.is.searchSelection()) &&
              k.set.filtered(), clearTimeout(k.timer), (k.timer = setTimeout(
              k.search,
              S.delay.search
            ));
          },
            ...
            click: function(t) {
              ...
              t.shiftKey
                ...
                : t.ctrlKey
                    ...
                    : (o.removeClass(T.active), n.addClass(
                        T.active
          ...
          item: {
            mouseenter: function(t) {
              ...
              !s &&
                r &&
                (clearTimeout(k.itemTimer), (k.itemTimer = setTimeout(
                  function() {
              ...
              c ||
                ...
                (k.is.searchSelection() &&
                  (S.allowAdditions &&
                    ...
                    1 == n ||
                    k.focusSearch(!0)), S.useLabels ||
                  (k.remove.filteredItem(), k.set.scrollPosition(
                    i
            ...
            keydown: function(e) {
              ...
              if (n) {
                ...
                t == E.leftArrow
                  ...
                  : t == E.rightArrow
                      ? (m && !s && i.first().addClass(T.active), s &&
                          (e.shiftKey
                            ? k.verbose('Adding next label to selection')
                            : (k.verbose('Selecting next label'), i.removeClass(
                                T.active
                              )), u
                            ? d
                                ? f ? i.removeClass(T.active) : k.focusSearch()
                                : l
                                    ? o.next(D.siblingLabel).addClass(T.active)
                                    : o.addClass(T.active)
                            : o
                                .next(D.siblingLabel)
                                .addClass(T.active), e.preventDefault()))
                      : t == E.deleteKey || t == E.backspace
                          ? s
                              ? (k.verbose('Removing active labels'), u &&
                                  d &&
                                  !f &&
                                  k.focusSearch(), o
                                  .last()
                                  .next(D.siblingLabel)
                                  .addClass(T.active), k.remove.activeLabels(
                                  o
                                ), e.preventDefault())
                              : g &&
                                  !s &&
              ...
              if (
                (h &&
                  (k.verbose(
                    ...
                    s
                  ), k.event.item.click.call(s, e), k.is.searchSelection() &&
                    k.remove.searchTerm()), k.is.visible())
              ) {
                if (
                  ((t == E.enter || p) &&
                    (t == E.enter && m && f && !S.allowCategorySelection
                      ...
                      : g &&
                          (k.verbose(
                            'Selecting item from keyboard shortcut',
                            s
                          ), k.event.item.click.call(
                            s,
                            e
                          ), k.is.searchSelection() &&
                            k.remove.searchTerm()), e.preventDefault()), m &&
                    (t == E.leftArrow &&
                      ((o = u[0] !== Q[0]), o &&
                        (k.verbose(
                          'Left key pressed, closing sub-menu'
                        ), k.animate.hide(!1, u), s.removeClass(
                          T.selected
                        ), u
                          .closest(D.item)
                          .addClass(T.selected), e.preventDefault())), t ==
                      E.rightArrow &&
                      f &&
                      (k.verbose(
                        'Right key pressed, opening sub-menu'
                      ), k.animate.show(!1, c), s.removeClass(
                        T.selected
                      ), c
                        .find(D.item)
                        .eq(0)
                  ...
                  if (
                    ((i = m && d
                      ? s.prevAll(D.item + ':not(' + D.unselectable + ')').eq(0)
                      : X.eq(0)), l.index(i) < 0)
                  )
                    return k.verbose(
                  ...
                  ), s.removeClass(T.selected), i.addClass(
                    T.selected
                  ), k.set.scrollPosition(i), S.selectOnKeydown &&
                    k.is.single() &&
                    k.set.selectedItem(i), e.preventDefault();
                }
                if (t == E.downArrow) {
                  if (
                    ((i = m && d
                      ? (i = s
                          .nextAll(D.item + ':not(' + D.unselectable + ')')
                          .eq(0))
                      : X.eq(0)), 0 === i.length)
                  )
                    return k.verbose(
                  ...
                  ), X.removeClass(T.selected), i.addClass(
                    T.selected
                  ), k.set.scrollPosition(i), S.selectOnKeydown &&
                    k.is.single() &&
                    k.set.selectedItem(i), e.preventDefault();
                }
                t == E.pageUp && (k.scrollPage('up'), e.preventDefault()), t ==
                  E.pageDown && (k.scrollPage('down'), e.preventDefault()), t ==
                  E.escape &&
                  (k.verbose('Escape key pressed, closing dropdown'), k.hide());
              } else
                p && e.preventDefault(), t != E.downArrow ||
                  k.is.visible() ||
                  (k.verbose(
                    'Down key pressed, showing dropdown'
                  ), k.select.firstUnfiltered(), k.show(), e.preventDefault());
            } else
        ...
        trigger: {
          change: function() {
            ...
            t &&
              (k.verbose('Triggering native change event'), e.initEvent(
                'change',
                !0,
                !1
              ), t.dispatchEvent(e));
        ...
        determine: {
          selectAction: function(t, n) {
            k.verbose('Determining action', S.action), e.isFunction(
              k.action[S.action]
            )
              ? (k.verbose(
        ...
        action: {
          ...
          activate: function(t, n, o) {
            if (((n = n !== i ? n : t), k.can.activate(e(o)))) {
              if (
                (k.set.selected(n, e(o)), k.is.multiple() &&
                  !k.is.allFiltered())
              )
                return;
              k.hideAndClear();
          ...
          select: function(t, n, o) {
            if (((n = n !== i ? n : t), k.can.activate(e(o)))) {
              if (
                (k.set.value(n, e(o)), k.is.multiple() && !k.is.allFiltered())
              )
                return;
              k.hideAndClear();
            }
        ...
        get: {
          ...
          searchWidth: function(e) {
            return (e = e !== i ? e : V.val()), H.text(e), Math.ceil(
              H.width() + 1
            );
          },
          selectionCount: function() {
            ...
            return (t = k.is.multiple()
              ? e.isArray(n) ? n.length : 0
              : '' !== k.get.value() ? 1 : 0);
          },
          transition: function(e) {
            return 'auto' == S.transition
              ? k.is.upward(e) ? 'slide up' : 'slide down'
              : S.transition;
          },
          userValues: function() {
            var t = k.get.values();
            return !!t &&
              ((t = e.isArray(t) ? t : [t]), e.grep(t, function(e) {
          ...
          caretPosition: function() {
            ...
            return 'selectionStart' in i
              ? i.selectionStart
              : n.selection
                  ? (i.focus(), (e = n.selection.createRange()), (t = e.text.length), e.moveStart(
                      'character',
                      -i.value.length
                    ), e.text.length - t)
                  : void 0;
          ...
          values: function() {
            ...
            return '' === e
              ...
              : !k.has.selectInput() && k.is.multiple()
                  ? 'string' == typeof e ? e.split(S.delimiter) : ''
                  : e;
          },
          remoteValues: function() {
            var t = k.get.values(), n = !1;
            return t &&
              ('string' == typeof t && (t = [t]), e.each(t, function(e, t) {
          ...
          choiceText: function(t, n) {
            if (((n = n !== i ? n : S.preserveHTML), t))
              return t.find(D.menu).length > 0 &&
                (k.verbose(
                  'Retrieving text of element with sub-menu'
                ), (t = t.clone()), t.find(D.menu).remove(), t
                  .find(D.menuIcon)
                  .remove()), t.data(P.text) !== i
                ? t.data(P.text)
                : n ? e.trim(t.html()) : e.trim(t.text());
          },
          choiceValue: function(t, n) {
            return (n = n || k.get.choiceText(t)), !!t &&
              (t.data(P.value) !== i
          ...
          selectValues: function() {
            ...
            return (t.values = []), I.find('option').each(function() {
              ...
              (k.debug(
                ...
                S.placeholder
              ), (t.placeholder = S.placeholder)), S.sortSelect
              ? (t.values.sort(function(e, t) {
                  return e.name > t.name ? 1 : -1;
                }), k.debug('Retrieved and sorted values from select', t))
              : k.debug('Retrieved values from select', t), t;
          },
          activeItem: function() {
          ...
          item: function(t, n) {
            ...
            return (t = t !== i
              ? t
              : k.get.values() !== i ? k.get.values() : k.get.text()), (o = a
              ? t.length > 0
              : t !== i && null !== t), (a = k.is.multiple() &&
              e.isArray(t)), (n = '' === t || 0 === t || (n || !1)), o &&
              X.each(function() {
                var o = e(this),
        ...
        check: {
          maxSelections: function(e) {
            return !S.maxSelections ||
              ((e = e !== i ? e : k.get.selectionCount()), e >= S.maxSelections
                ? (k.debug('Maximum selection count reached'), S.useLabels &&
                    (X.addClass(T.filtered), k.add.message(
                      A.maxSelections
                    )), !0)
                : (k.verbose(
                    'No longer at maximum selection count'
                  ), k.remove.message(), k.remove.filteredItem(), k.is.searchSelection() &&
                    k.filterItems(), !1));
          }
        },
        restore: {
          ...
          defaultValue: function() {
            ...
            e !== i &&
              (k.debug('Restoring default value', e), '' !== e
                ? (k.set.value(e), k.set.selected())
                : (k.remove.activeItem(), k.remove.selectedItem()));
          },
          labels: function() {
            S.allowAdditions &&
              (S.useLabels || (k.error(q.labels), (S.useLabels = !0)), k.debug(
                'Restoring selected values'
              ), k.create.userLabels()), k.check.maxSelections();
          },
          selected: function() {
            k.restore.values(), k.is.multiple()
              ? (k.debug(
          ...
          values: function() {
            k.set.initialLoad(), S.apiSettings &&
              S.saveRemoteData &&
              k.get.remoteValues()
              ? k.restore.remoteValues()
              : k.set.selected(), k.remove.initialLoad();
          },
          remoteValues: function() {
            var t = k.get.remoteValues();
            k.debug('Recreating selected from session data', t), t &&
              (k.is.single()
        ...
        save: {
          ...
          placeholderText: function() {
            ...
            S.placeholder !== !1 &&
              ...
              ((e = k.get.text()), k.verbose(
                'Saving placeholder text as',
                e
        ...
        clear: function() {
          k.is.multiple() && S.useLabels
            ? k.remove.labels()
            : (k.remove.activeItem(), k.remove.selectedItem()), k.set.placeholderText(), k.clearValue();
        },
        clearValue: function() {
          k.set.value('');
        },
        scrollPage: function(e, t) {
          ...
          (o = 'up' == e ? f.index(a) - u : f.index(a) + u), (n = 'up' == e
            ? o >= 0
            : o < f.length), (i = n
            ? f.eq(o)
            : 'up' == e ? f.first() : f.last()), i.length > 0 &&
            (k.debug('Scrolling page', e, i), a.removeClass(
              T.selected
            ), i.addClass(T.selected), S.selectOnKeydown &&
              k.is.single() &&
              k.set.selectedItem(i), r.scrollTop(d));
        },
        set: {
          filtered: function() {
            var e = k.is.multiple(),
            ...
            e &&
              o &&
              (k.verbose('Adjusting input width', a, S.glyphWidth), V.css(
                'width',
                a
              )), o || (n && r)
              ? (k.verbose('Hiding placeholder text'), N.addClass(T.filtered))
              : (!e || (n && !r)) &&
                  (k.verbose('Showing placeholder text'), N.removeClass(
                    T.filtered
                  ));
          },
          empty: function() {
          ...
          placeholderText: function(e) {
            (e = e || k.get.placeholderText()), k.debug(
              'Setting placeholder text',
              e
            ), k.set.text(e), N.addClass(T.placeholder);
          },
          tabbable: function() {
            k.has.search()
              ? (k.debug('Added tabindex to searchable dropdown'), V.val(
                  ''
                ).attr('tabindex', 0), Q.attr('tabindex', -1))
              : (k.debug('Added tabindex to dropdown'), I.attr('tabindex') ===
                  i && (I.attr('tabindex', 0), Q.attr('tabindex', -1)));
          },
          initialLoad: function() {
          ...
          scrollPosition: function(e, t) {
            ...
            (e = e || k.get.selectedItem()), (n = e.closest(D.menu)), (o = e &&
              e.length > 0), (t = t !== i && t), e &&
              n.length > 0 &&
              o &&
              ((r = e.position().top), n.addClass(
                T.loading
              ), (l = n.scrollTop()), (s = n.offset().top), (r = e.offset().top), (a = l -
                s +
                r), t ||
                ((c = n.height()), (d = l + c < a + f), (u = a - f <
                  l)), k.debug('Scrolling to active item', a), (t || u || d) &&
                n.scrollTop(a), n.removeClass(T.loading));
          },
          text: function(e) {
            'select' !== S.action &&
              ('combo' == S.action
                ? (k.debug('Changing combo button text', e, B), S.preserveHTML
                    ? B.html(e)
                    : B.text(e))
                : (e !== k.get.placeholderText() &&
                    N.removeClass(T.placeholder), k.debug(
                    'Changing text',
                    e,
                    N
                  ), N.removeClass(T.filtered), S.preserveHTML
                    ? N.html(e)
                    : N.text(e)));
          },
          selectedItem: function(e) {
            ...
            k.debug(
              ...
              e
            ), k.remove.activeItem(), k.set.partialSearch(n), k.set.activeItem(
              e
            ), k.set.selected(t, e), k.set.text(n);
          },
          selectedLetter: function(t) {
            var n,
              ...
              a = !1;
            o &&
              ((n = i.nextAll(X).eq(0)), k.has.firstLetter(n, t) &&
                (a = n)), a ||
              X.each(function() {
              ...
              (k.verbose(
                ...
                t
              ), k.set.scrollPosition(a), i.removeClass(T.selected), a.addClass(
                T.selected
              ), S.selectOnKeydown && k.is.single() && k.set.selectedItem(a));
          },
          direction: function(e) {
            'auto' == S.direction
              ? k.is.onScreen(e) ? k.remove.upward(e) : k.set.upward(e)
          ...
          value: function(e, t, n) {
            ...
            if (a) {
              ...
              k.is.single() &&
                k.has.selectInput() &&
                k.can.extendSelect() &&
                (k.debug('Adding user option', e), k.add.optionValue(
                  e
                )), k.debug('Updating input value', o, r), (K = !0), U.val(
                o
              ), S.fireOnInit === !1 && k.is.initialLoad()
                ? k.debug('Input native change event ignored on initial load')
                : k.trigger.change(), (K = !1);
            } else
              k.verbose('Storing value in metadata', o, U), o !== r &&
                I.data(P.value, s);
            S.fireOnInit === !1 && k.is.initialLoad()
          ...
          selected: function(t, n) {
            ...
            (n = S.allowAdditions
              ...
              : n || k.get.item(t)), n &&
              (k.debug('Setting selected menu item to', n), k.is.multiple() &&
                k.remove.searchWidth(), k.is.single()
                ? (k.remove.activeItem(), k.remove.selectedItem())
                : S.useLabels && k.remove.selectedItem(), n.each(function() {
                var t = e(this),
                ...
                i
                  ? !s || l
                      ? (S.apiSettings &&
                          S.saveRemoteData &&
                          k.save.remoteData(o, a), S.useLabels
                          ? (k.add.value(a, o, t), k.add.label(
                              a,
                              o,
                              c
                            ), k.set.activeItem(
                              t
                            ), k.filterActive(), k.select.nextAvailable(n))
                          : (k.add.value(a, o, t), k.set.text(
                              k.add.variables(A.count)
                            ), k.set.activeItem(t)))
                      : r ||
                          (k.debug(
                  ...
                  : (S.apiSettings &&
                      S.saveRemoteData &&
                      k.save.remoteData(o, a), k.set.text(o), k.set.value(
                      a,
                      o,
                      t
        ...
        add: {
          label: function(t, n, i) {
            ...
            return (o = e('<a />')
              .addClass(T.label)
              .attr('data-value', r)
              .html(j.label(r, n))), (o = S.onLabelCreate.call(
              o,
              r,
              n
            )), k.has.label(t)
              ? void k.debug('Label already exists, skipping', r)
              : (S.label.variation && o.addClass(S.label.variation), void (i ===
                  !0
                  ? (k.debug('Animating in label', o), o
                      .addClass(T.hidden)
                      .insertBefore(a)
          ...
          optionValue: function(t) {
            var n = k.escape.value(t),
              ...
              o = i.length > 0;
            o ||
              (k.disconnect.selectObserver(), k.is.single() &&
                (k.verbose('Removing previous user addition'), U.find(
                  'option.' + T.addition
                ).remove()), e('<option/>')
                .prop('value', n)
                .addClass(T.addition)
                .html(t)
                .appendTo(U), k.verbose(
            ...
            if (!S.useLabels || !k.has.maxSelections()) {
              ...
              a
                ? (n
                    ...
                    .attr('data-' + P.value, e)
                    .attr('data-' + P.text, e)
                    .removeClass(T.filtered), S.hideAdditions ||
                ...
                : ((n = k.create.userChoice(e)), n.prependTo(Q), k.verbose(
                ...
                n
                  .addClass(T.selected)
                  .siblings()
                  .removeClass(T.selected), k.refreshItems();
            }
          },
          variables: function(e, t) {
            var n,
              ...
              r = e.search('{term}') !== -1;
            return k.verbose('Adding templated variables to message', e), o &&
              ((n = k.get.selectionCount()), (e = e.replace(
                '{count}',
                n
              ))), a &&
              ((n = k.get.selectionCount()), (e = e.replace(
              ...
              ((i = t || k.get.query()), (e = e.replace('{term}', i))), e;
          },
          value: function(t, n, i) {
            ...
            return '' === t
              ...
              : (e.isArray(a)
                  ...
                  : S.onAdd.call(Z, t, n, i), k.set.value(
                  o,
                  t,
                  n,
                  i
        ...
        remove: {
          ...
          filteredItem: function() {
            (S.useLabels && k.has.maxSelections()) ||
              (S.useLabels && k.is.multiple()
                ...
                : X.removeClass(T.filtered), k.remove.empty());
          },
              ...
              void n.each(function() {
                ...
                k.is.multiple()
                  ? S.useLabels
                      ...
                      : (k.remove.value(i, n, t), 0 === k.get.selectionCount()
                          ? k.set.placeholderText()
                  ...
                  : k.remove.value(
                      ...
                      n,
                      t
                    ), t.removeClass(T.filtered).removeClass(T.active), S.useLabels && t.removeClass(T.selected);
              });
          },
          selectedItem: function() {
          ...
          value: function(e, t, n) {
            ...
            k.has.selectInput()
              ? (k.verbose(
                  ...
                  e
                ), (i = k.remove.arrayValue(e, o)), k.remove.optionValue(e))
              : (k.verbose(
                  'Removing from delimited values',
                  e
                ), (i = k.remove.arrayValue(e, o)), (i = i.join(
                  S.delimiter
                ))), S.fireOnInit === !1 && k.is.initialLoad()
              ? k.verbose('No callback on initial load', S.onRemove)
              : S.onRemove.call(Z, e, t, n), k.set.value(
              i,
              t,
              n
          ...
          activeLabels: function(e) {
            (e = e || I.find(D.label).filter('.' + T.active)), k.verbose(
              'Removing active label selections',
              e
            ), k.remove.labels(e);
          },
          labels: function(t) {
            (t = t || I.find(D.label)), k.verbose(
              'Removing labels',
              t
            ), t.each(function() {
              var t = e(this),
          ...
          tabbable: function() {
            k.has.search()
              ? (k.debug('Searchable dropdown initialized'), V.removeAttr(
                  'tabindex'
                ), Q.removeAttr('tabindex'))
              : (k.debug('Simple selection dropdown initialized'), I.removeAttr(
                  'tabindex'
                ), Q.removeAttr('tabindex'));
          }
        },
        has: {
          ...
          minCharacters: function(e) {
            return !S.minCharacters ||
              ((e = e !== i ? String(e) : String(k.get.query())), e.length >=
                S.minCharacters);
          },
        ...
        is: {
          ...
          bubbledLabelClick: function(t) {
            return e(t.target).is('select, input') &&
          ...
          allFiltered: function() {
            return (k.is.multiple() || k.has.search()) &&
          ...
          onScreen: function(e) {
            ...
            return n.addClass(T.loading), (t = {
              ...
              below: t.context.scrollTop + t.context.height >=
        ...
        animate: {
          show: function(t, n) {
            ...
            (t = e.isFunction(t) ? t : function() {}), k.verbose(
              'Doing menu show animation',
              a
            ), k.set.direction(n), (o = k.get.transition(
              n
            )), k.is.selection() &&
              k.set.scrollPosition(k.get.selectedItem(), !0), (k.is.hidden(a) ||
              k.is.animating(a)) &&
              ('none' == o
          ...
          hide: function(t, n) {
            var o = n || Q,
              a = (n ? 0.9 * S.duration : S.duration, n
                ? function() {}
                : function() {
                    k.can.click() && k.unbind.intent(), k.remove.active();
                  }),
              r = k.get.transition(n);
            (t = e.isFunction(t) ? t : function() {}), (k.is.visible(o) ||
              k.is.animating(o)) &&
              (k.verbose('Doing menu hide animation', o), 'none' == r
                ...
                : e.fn.transition !== i && I.transition('is supported')
                    ? o.transition({
                        ...
                        onStart: a,
                        onComplete: function() {
                          'auto' == S.direction && k.remove.upward(n), t.call(
                            Z
                          );
                        }
                      })
        ...
        hideAndClear: function() {
          k.remove.searchTerm(), k.has.maxSelections() ||
            (k.has.search()
              ? k.hide(function() {
        ...
        delay: {
          show: function() {
            ...
            ), clearTimeout(k.timer), (k.timer = setTimeout(
              k.show,
              S.delay.show
            ));
          },
        ...
        escape: {
          value: function(t) {
            ...
            return k.has.selectInput() && !o && a
              ? (k.debug('Encoding quote values for use in select', t), n
                  ? (e.each(t, function(e, t) {
        ...
        invoke: function(t, n, o) {
          var r, s, l, c = J;
          return (n = n || g), (o = Z || o), 'string' == typeof t &&
            c !== i &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(n, o) {
              var a = n != r
    ...
    dropdown: function(t) {
      ...
      return (i += '<i class="dropdown icon"></i>'), (i += t.placeholder
        ? '<div class="default text">' + n + '</div>'
        : '<div class="text"></div>'), (i += '<div class="menu">'), e.each(
        t.values,
        function(e, t) {
          i += t.disabled
    ...
    return a.each(function() {
      ...
      (f = {
        initialize: function() {
          f.debug(
            'Initializing embed'
          ), f.determine.autoplay(), f.create(), f.bind.events(), f.instantiate();
        },
        instantiate: function() {
        ...
        destroy: function() {
          ...
          ), f.reset(), k.removeData(w).off(C);
        },
        refresh: function() {
          f.verbose('Refreshing selector cache'), (S = k.find(
            g.placeholder
          )), (T = k.find(g.icon)), (A = k.find(g.embed));
        },
        bind: {
          events: function() {
            f.has.placeholder() &&
              (f.debug('Adding placeholder events'), k
        ...
        createPlaceholder: function(e) {
          ...
          f.generate.embed(n);
          (e = e || f.get.placeholder()), k.html(x.placeholder(e, t)), f.debug(
        ...
        createEmbed: function(t) {
          f.refresh(), (t = t || f.get.url()), (A = e('<div/>')
            .addClass(p.embed)
            .html(f.generate.embed(t))
            .appendTo(k)), m.onCreate.call(R, t), f.debug(
        ...
        change: function(e, t, n) {
          f.debug('Changing video to ', e, t, n), k
            .data(b.source, e)
            .data(b.id, t), n
            ? k.data(b.url, n)
            : k.removeData(b.url), f.has.embed() ? f.changeEmbed() : f.create();
        },
        reset: function() {
          f.debug(
            'Clearing embed and showing placeholder'
          ), f.remove.active(), f.remove.embed(), f.showPlaceholder(), m.onReset.call(
            R
          );
        },
        show: function() {
        ...
        showPlaceholder: function() {
          ...
          ), f.remove.active(), m.onPlaceholderDisplay.call(R);
        },
        get: {
          id: function() {
          ...
          icon: function() {
            return m.icon
              ? m.icon
              : k.data(b.icon) !== i ? k.data(b.icon) : f.determine.icon();
          },
          source: function(e) {
            return m.source
              ? m.source
          ...
          url: function() {
            return m.url
              ? m.url
              : k.data(b.url) !== i ? k.data(b.url) : f.determine.url();
          }
        },
        determine: {
          autoplay: function() {
          ...
          url: function() {
            ...
            return (e = h[n] !== i && h[n].url.replace('{id}', t)), e &&
              k.data(b.url, e), e;
          }
        },
        set: {
        ...
        generate: {
          ...
          parameters: function(t, n) {
            ...
            return (n = n || m.parameters), n &&
              (o = e.extend({}, o, n)), (o = m.onEmbed(o)), f.encode.parameters(
              o
            );
          }
        },
        ...
        invoke: function(t, n, a) {
          var r, s, l, c = E;
          return (n = n || d), (a = R || a), 'string' == typeof t &&
            c !== i &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(n, o) {
              var a = n != r
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.modal = function(o) {
    var a,
      r = e(this),
      s = e(t),
      l = e(n),
      ...
      (S = {
        initialize: function() {
          S.verbose(
            'Initializing dimmer',
            q
          ), S.create.id(), S.create.dimmer(), S.refreshModals(), S.bind.events(), T.observeChanges &&
        ...
        create: {
          dimmer: function() {
            ...
            return T.inverted &&
              (n.variation = n.variation !== i
                ? n.variation + ' inverted'
                : 'inverted'), e.fn.dimmer === i
              ? void S.error(P.dimmer)
              : (S.debug('Creating dimmer with settings', n), (y = q.dimmer(
                  n
                )), T.detachable
                  ? (S.verbose(
                      'Modal is detachable, moving content into dimmer'
                    ), y.dimmer('add content', D))
                  : S.set.undetached(), T.blurring &&
                  y.addClass(R.blurring), void (x = y.dimmer('get dimmer')));
          },
          id: function() {
            (w = (Math.random().toString(16) + '000000000').substr(
              2,
              8
            )), (C = '.' + w), S.verbose('Creating unique id for element', w);
          }
        },
        destroy: function() {
          S.verbose('Destroying previous modal'), D.removeData(O).off(F), s.off(
            C
          ), x.off(C), j.off(F), q.dimmer('destroy');
        },
        observeChanges: function() {
          'MutationObserver' in t &&
            ((k = new MutationObserver(function(e) {
              S.debug('DOM tree modified, refreshing'), S.refresh();
            })), k.observe(z, { childList: !0, subtree: !0 }), S.debug(
              'Setting up mutation observer',
              k
            ));
        },
        ...
        attachEvents: function(t, n) {
          var i = e(t);
          (n = e.isFunction(S[n]) ? S[n] : S.toggle), i.length > 0
            ? (S.debug('Attaching modal events to element', t, n), i
                .off(F)
                .on('click' + F, n))
        ...
        bind: {
          events: function() {
            S.verbose('Attaching events'), D.on(
              'click' + F,
              A.close,
              S.event.close
            )
              .on('click' + F, A.approve, S.event.approve)
              .on('click' + F, A.deny, S.event.deny), s.on(
              'resize' + C,
              S.event.resize
            );
          }
        ...
        event: {
          ...
          click: function(t) {
            ...
            !o &&
              a &&
              (S.debug('Dimmer clicked, hiding all modals'), S.is.active() &&
                (S.remove.clickaway(), T.allowMultiple
                  ? S.hide()
                  : S.hideAll()));
          },
        ...
        show: function(t) {
          (t = e.isFunction(t)
            ? t
            : function() {}), S.refreshModals(), S.showModal(t);
        },
        hide: function(t) {
          (t = e.isFunction(t)
            ? t
            : function() {}), S.refreshModals(), S.hideModal(t);
        },
        showModal: function(t) {
          (t = e.isFunction(t) ? t : function() {}), S.is.animating() ||
            !S.is.active()
            ? (S.showDimmer(), S.cacheSizes(), S.set.position(), S.set.screenHeight(), S.set.type(), S.set.clickaway(), !T.allowMultiple &&
                S.others.active()
                ? S.hideOthers(S.showModal)
                : (T.onShow.call(z), T.transition &&
                    e.fn.transition !== i &&
                    D.transition('is supported')
                    ? (S.debug(
                        ...
                        useFailSafe: !0,
                        onComplete: function() {
                          T.onVisible.apply(z), T.keyboardShortcuts &&
                            S.add.keyboardShortcuts(), S.save.focus(), S.set.active(), T.autofocus &&
                            S.set.autofocus(), t();
                        }
                      }))
        ...
        hideModal: function(t, n) {
          return (t = e.isFunction(t) ? t : function() {}), S.debug(
            'Hiding modal'
          ), T.onHide.call(z, e(this)) === !1
            ? void S.verbose('Hide callback returned false cancelling hide')
            : void ((S.is.animating() || S.is.active()) &&
                (T.transition &&
                  e.fn.transition !== i &&
                  D.transition('is supported')
                  ? (S.remove.active(), D.transition({
                      debug: T.debug,
                      ...
                      onStart: function() {
                        S.others.active() ||
                          n ||
                          S.hideDimmer(), T.keyboardShortcuts &&
        ...
        hideAll: function(t) {
          ...
          (t = e.isFunction(t) ? t : function() {}), n.length > 0 &&
            (S.debug('Hiding all visible modals'), S.hideDimmer(), n.modal(
              'hide modal',
              t
            ));
        },
        hideOthers: function(t) {
          ...
          (t = e.isFunction(t) ? t : function() {}), n.length > 0 &&
            (S.debug('Hiding other modals', v), n.modal('hide modal', t, !0));
        },
        others: {
          active: function() {
        ...
        add: {
          keyboardShortcuts: function() {
            S.verbose('Adding keyboard shortcuts'), l.on(
              'keyup' + F,
              S.event.keyboard
            );
          }
        ...
        set: {
          ...
          type: function() {
            S.can.fit()
              ? (S.verbose('Modal fits on screen'), S.others.active() ||
                  S.others.animating() ||
                  S.remove.scrolling())
              : (S.verbose(
        ...
        invoke: function(t, n, o) {
          var r, s, l, c = M;
          return (n = n || p), (o = z || o), 'string' == typeof t &&
            c !== i &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(n, o) {
              var a = n != r
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    return a.each(function() {
      ...
      (a = {
        initialize: function() {
          a.verbose('Initializing element'), b
            .on('click' + h, m.close, a.dismiss)
            .data(v, a), f.detachable &&
            b.parent()[0] !== y[0] &&
            b.detach().prependTo(y), f.displayTime > 0 &&
            setTimeout(a.hide, f.displayTime), a.show();
        },
        destroy: function() {
        ...
        show: function() {
          a.should.show() &&
            !b.is(':visible') &&
            (a.debug('Showing nag', f.animation.show), 'fade' ==
              f.animation.show
              ? b.fadeIn(f.duration, f.easing)
              : b.slideDown(f.duration, f.easing));
        },
        hide: function() {
          a.debug('Showing nag', f.animation.hide), 'fade' == f.animation.show
            ? b.fadeIn(f.duration, f.easing)
            : b.slideUp(f.duration, f.easing);
        },
        onHide: function() {
          a.debug('Removing nag', f.animation.hide), b.remove(), f.onHide &&
            f.onHide();
        },
        dismiss: function(e) {
          f.storageMethod &&
        ...
        get: {
          storageOptions: function() {
            var e = {};
            return f.expires && (e.expires = f.expires), f.domain &&
              (e.domain = f.domain), f.path && (e.path = f.path), e;
          }
        },
        clear: function() {
        ...
        storage: {
          set: function(n, o) {
            ...
            if ('localstorage' == f.storageMethod && t.localStorage !== i)
              t.localStorage.setItem(n, o), a.debug(
              ...
              t.sessionStorage.setItem(n, o), a.debug(
          ...
          get: function(n, o) {
            var r;
            return 'localstorage' == f.storageMethod && t.localStorage !== i
              ? (r = t.localStorage.getItem(n))
              : 'sessionstorage' == f.storageMethod && t.sessionStorage !== i
                  ? (r = t.sessionStorage.getItem(n))
                  : e.cookie !== i
                      ? (r = e.cookie(n))
                      : a.error(g.noCookieStorage), ('undefined' != r &&
              'null' != r &&
              r !== i &&
              null !== r) ||
              (r = i), r;
        ...
        invoke: function(t, n, r) {
          var s, l, c, u = C;
          return (n = n || d), (r = x || r), 'string' == typeof t &&
            u !== i &&
            ((t = t.split(/[\. ]/)), (s = t.length -
              1), e.each(t, function(n, o) {
              var r = n != s
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.popup = function(o) {
    var a,
      r = e(this),
      s = e(n),
      l = e(t),
      ...
      (C = {
        initialize: function() {
          C.debug(
            'Initializing',
            F
          ), C.createID(), C.bind.events(), !C.exists() &&
            w.preserve &&
            C.create(), w.observeChanges && C.observeChanges(), C.instantiate();
        },
        instantiate: function() {
        ...
        observeChanges: function() {
          'MutationObserver' in t &&
            ((b = new MutationObserver(C.event.documentChanged)), b.observe(n, {
              childList: !0,
              subtree: !0
        ...
        refresh: function() {
          w.popup
            ? (r = e(w.popup).eq(0))
            : w.inline &&
                ((r = j.nextAll(k.popup).eq(0)), (w.popup = r)), w.popup
            ? (r.addClass(S.loading), (v = C.get.offsetParent()), r.removeClass(
                S.loading
              ), w.movePopup &&
                C.has.popup() &&
            ...
            : (v = w.inline
                ...
                : C.has.popup() ? C.get.offsetParent(r) : c), v.is('html') &&
            v[0] !== c[0] &&
            (C.debug(
              'Setting page as offset parent'
        ...
        destroy: function() {
          C.debug('Destroying previous module'), b && b.disconnect(), r &&
            !w.preserve &&
            C.removePopup(), clearTimeout(C.hideTimer), clearTimeout(
            C.showTimer
          ), C.unbind.close(), C.unbind.events(), F.removeData(P);
        },
        event: {
          start: function(t) {
            var n = e.isPlainObject(w.delay) ? w.delay.show : w.delay;
            clearTimeout(C.hideTimer), I ||
              (C.showTimer = setTimeout(C.show, n));
          },
          end: function() {
        ...
        create: function() {
          ...
          t || i || n
            ? (C.debug('Creating pop-up html'), t ||
                (t = w.templates.popup({ title: n, content: i })), (r = e(
                '<div/>'
              )
                .addClass(S.popup)
                .data(A.activator, F)
                ...
                : (C.verbose('Appending popup element to body', r), r.appendTo(
                    O
                  )), C.refresh(), C.set.variation(), w.hoverable &&
                C.bind.popup(), w.onCreate.call(r, L))
            : 0 !== j.next(k.popup).length
                ? (C.verbose(
                    'Pre-existing popup found'
                  ), (w.inline = !0), (w.popup = j
                    .next(k.popup)
                    .data(A.activator, F)), C.refresh(), w.hoverable &&
                    C.bind.popup())
                : w.popup
                    ? (e(w.popup).data(A.activator, F), C.verbose(
                        'Used popup specified in settings'
                      ), C.refresh(), w.hoverable && C.bind.popup())
        ...
        createID: function() {
          (x = (Math.random().toString(16) + '000000000').substr(
            2,
            8
          )), (y = '.' + x), C.verbose('Creating unique id for element', x);
        },
        toggle: function() {
          C.debug('Toggling pop-up'), C.is.hidden()
            ? (C.debug(
                'Popup is hidden, showing pop-up'
              ), C.unbind.close(), C.show())
            : (C.debug('Popup is visible, hiding pop-up'), C.hide());
        },
        show: function(e) {
          if (
            ((e = e || function() {}), C.debug(
              'Showing pop-up',
              w.transition
            ...
            w.preserve || w.popup || C.refresh(), r &&
              C.set.position() &&
              (C.save.conditions(), w.exclusive && C.hideAll(), C.animate.show(
                e
              ));
          }
        },
        hide: function(e) {
          if (((e = e || function() {}), C.is.visible() || C.is.animating())) {
            ...
            C.remove.visible(), C.unbind.close(), C.restore.conditions(), C.animate.hide(
              e
            );
          }
        },
        ...
        exists: function() {
          return !!r &&
            (w.inline || w.popup ? C.has.popup() : r.closest(O).length >= 1);
        },
        removePopup: function() {
          C.has.popup() &&
            !w.popup &&
            (C.debug('Removing popup', r), r.remove(), (r = i), w.onRemove.call(
              r,
              L
            ));
        },
        save: {
          conditions: function() {
            (C.cache = { title: F.attr('title') }), C.cache.title &&
              F.removeAttr('title'), C.verbose(
        ...
        restore: {
          conditions: function() {
            return C.cache &&
              C.cache.title &&
              (F.attr('title', C.cache.title), C.verbose(
        ...
        animate: {
          show: function(t) {
            (t = e.isFunction(t) ? t : function() {}), w.transition &&
              e.fn.transition !== i &&
              F.transition('is supported')
              ? (C.set.visible(), r.transition({
          ...
          hide: function(t) {
            return (t = e.isFunction(t) ? t : function() {}), C.debug(
              'Hiding pop-up'
            ), w.onHide.call(r, L) === !1
              ? void C.debug(
                  'onHide callback returned false, cancelling popup animation'
        ...
        get: {
          ...
          content: function() {
            return F.removeData(A.content), F.data(A.content) ||
              F.attr('title') ||
              w.content;
          },
          variation: function() {
            return F.removeData(A.variation), F.data(A.variation) ||
              w.variation;
          },
          popup: function() {
            return r;
          ...
          calculations: function() {
            var e,
              n = j[0],
              i = q[0] == t,
              o = w.inline || (w.popup && w.movePopup)
                ? j.position()
                : j.offset(),
            ...
            return (s = {
              ...
              : 0), (s.target.margin.left = w.inline
              ? C.is.rtl()
                  ? parseInt(
          ...
          distanceFromBoundary: function(e, t) {
            var n, i, o = {};
            return (t = t ||
              C.get.calculations()), (n = t.popup), (i = t.boundary), e &&
              ((o = {
                top: e.top - i.top,
                left: e.left - i.left,
          ...
          offsetParent: function(t) {
            ...
            if (o)
              for (
                ...
                (o = o.parentNode), (a = e(o)), (r = 'none' ===
                  a.css('transform')), (s = 'static' ===
                  a.css('position')), (l = a.is('html'));
          ...
          nextPosition: function(e) {
            ...
            return M ||
              ...
              ), (M = C.get.positions())), C.debug(
              'Recording last position tried',
              e
            ), (M[e] = !0), 'opposite' === w.prefer &&
              ((u = [o[n], i]), (u = u.join(' ')), (l = M[u] === !0), C.debug(
                'Trying opposite strategy',
                u
              )), 'adjacent' === w.prefer &&
              s &&
              ((u = [n, a[i]]), (u = u.join(' ')), (c = M[u] === !0), C.debug(
                'Trying adjacent strategy',
                u
              )), (c || l) &&
              (C.debug('Using backup position', u), (u = r[e])), u;
          }
        },
        set: {
          position: function(e, t) {
            ...
            var n, o, a, s, l, c, u, d;
            if (
              ((t = t || C.get.calculations()), (e = e ||
                F.data(A.position) ||
                w.position), (n = F.data(A.offset) ||
                w.offset), (o = w.distanceAway), (a = t.target), (s = t.popup), (l = t.parent), 0 ===
                a.width &&
                0 === a.height &&
                !C.is.svg(a.element))
            )
            ...
            switch ((w.inline &&
              (C.debug(
                ...
                : 'top left' == e || 'top center' == e || 'top right' == e
                    ...
                    : ((n += a.margin.left), (o += a.margin.top))), C.debug(
              ...
              })), C.debug('RTL: Popup position updated', e)), z ==
              w.maxSearchDepth &&
            ...
            if (
              (c === i && C.error(T.invalidPosition, e), C.debug(
                ...
                .addClass(
                  S.loading
                ), (u = C.get.popupOffset()), (d = C.get.distanceFromBoundary(
                u,
                t
              )), C.is.offstage(d, e))
            ) {
              if (
                (C.debug('Position is outside viewport', e), z <
                  w.maxSearchDepth)
              )
                return z++, (e = C.get.nextPosition(e)), C.debug(
                  'Trying new position',
                  e
              ...
              if (!w.lastResort)
                return C.debug(
                  ...
                  T.cannotPlace,
                  L
                ), C.remove.attempts(), C.remove.loading(), C.reset(), w.onUnplaceable.call(
                  r,
                  L
                ), !1;
            ...
            return C.debug(
              ...
              e
            ), C.remove.attempts(), C.remove.loading(), w.setFluidWidth &&
              C.is.fluid() &&
              C.set.fluidWidth(t), !0;
          },
          fluidWidth: function(e) {
            (e = e || C.get.calculations()), C.debug(
              'Automatically setting element width to parent width',
              e.parent.width
            ), r.css('width', e.container.width);
          },
          variation: function(e) {
            (e = e || C.get.variation()), e &&
              C.has.popup() &&
              (C.verbose('Adding variation to popup', e), r.addClass(e));
          },
          visible: function() {
        ...
        remove: {
          ...
          variation: function(e) {
            (e = e || C.get.variation()), e &&
              (C.verbose('Removing variation', e), r.removeClass(e));
          },
          visible: function() {
        ...
        bind: {
          events: function() {
            C.debug('Binding popup events to module'), 'click' == w.on &&
              F.on('click' + E, C.toggle), 'hover' == w.on &&
              d &&
              F.on('touchstart' + E, C.event.touchstart), C.get.startEvent() &&
              F.on(C.get.startEvent() + E, C.event.start).on(
                C.get.endEvent() + E,
                C.event.end
              ), w.target && C.debug('Target set to element', j), l.on(
              'resize' + y,
              C.event.resize
            );
          },
          popup: function() {
            C.verbose('Allowing hover events on popup to prevent closing'), r &&
              C.has.popup() &&
              r
          ...
          close: function() {
            (w.hideOnScroll === !0 ||
              ...
              D.one(C.get.scrollEvent() + y, C.event.hideGracefully), 'hover' ==
              w.on &&
              I &&
              (C.verbose(
        ...
        invoke: function(t, n, o) {
          var r, s, l, c = N;
          return (n = n || h), (o = L || o), 'string' == typeof t &&
            c !== i &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(n, o) {
              var a = n != r
    ...
    templates: {
      ...
      popup: function(t) {
        ...
        return typeof t !== i &&
          (typeof t.title !== i &&
            t.title &&
            ((t.title = o(t.title)), (n += '<div class="header">' +
              t.title +
              '</div>')), typeof t.content !== i &&
            t.content &&
            ((t.content = o(t.content)), (n += '<div class="content">' +
              t.content +
              '</div>'))), n;
      }
    }
      ...
      (f = {
        initialize: function() {
          f.debug(
            ...
            m
          ), f.set.duration(), f.set.transitionEvent(), f.read.metadata(), f.read.settings(), f.instantiate();
        },
        instantiate: function() {
          f.verbose('Storing instance of progress', f), (A = f), C.data(x, f);
        },
        destroy: function() {
          f.verbose('Destroying previous progress for', C), clearInterval(
            A.interval
          ), f.remove.state(), C.removeData(x), (A = i);
        },
        reset: function() {
        ...
        read: {
          metadata: function() {
            ...
            e.percent &&
              ...
              (f.debug('Total value set from metadata', e.total), f.set.total(
                e.total
              )), e.value &&
              (f.debug('Current value set from metadata', e.value), f.set.value(
                e.value
              ), f.set.progress(e.value));
          },
          settings: function() {
            m.total !== !1 &&
              (f.debug('Current total set in settings', m.total), f.set.total(
                m.total
              )), m.value !== !1 &&
              (f.debug('Current value set in settings', m.value), f.set.value(
                m.value
              ), f.set.progress(f.value)), m.percent !== !1 &&
              (f.debug(
        ...
        increment: function(e) {
          ...
          f.has.total()
            ...
            : ((n = f.get.percent()), (e = e || f.get.randomValue()), (i = n +
                e), (t = 100), f.debug(
                'Incrementing percentage by',
                n,
                i
              )), (i = f.get.normalizedValue(i)), f.set.progress(i);
        },
        decrement: function(e) {
          var t, n, i = f.get.total();
          i
            ? ((t = f.get.value()), (e = e || 1), (n = t - e), f.debug(
                'Decrementing value by',
                e,
                t
              ))
            : ((t = f.get.percent()), (e = e || f.get.randomValue()), (n = t -
                e), f.debug(
                'Decrementing percentage by',
                e,
                t
              )), (n = f.get.normalizedValue(n)), f.set.progress(n);
        },
        has: {
        ...
        remove: {
          progressPoll: function() {
            f.verbose('Removing progress poll timer'), f.progressPoll &&
          ...
          state: function() {
            ...
            ), delete f.total, delete f.percent, delete f.value;
          },
          active: function() {
        ...
        set: {
          barWidth: function(e) {
            e > 100
              ...
              : e < 0
                  ? f.error(b.tooLow, e)
                  : (w.css('width', e + '%'), C.attr(
                      'data-percent',
                      parseInt(e, 10)
                    ));
          },
          duration: function(e) {
            (e = e || m.duration), (e = 'number' == typeof e
              ? e + 'ms'
              : e), f.verbose(
          ...
          percent: function(e) {
            (e = 'string' == typeof e
              ...
              : Math.round(e)), (f.percent = e), f.has.total() ||
              ((f.value = m.precision > 0
                ? Math.round(e / 100 * f.total * (10 * m.precision)) /
                    (10 * m.precision)
                : Math.round(e / 100 * f.total * 10) / 10), m.limitValues &&
                (f.value = f.value > 100
                  ? 100
                  : f.value < 0 ? 0 : f.value)), f.set.barWidth(
              e
            ), f.set.labelInterval(), f.set.labels(), m.onChange.call(
              T,
              e,
              f.value,
              f.total
          ...
          labelInterval: function() {
            var t = function() {
              ...
              ), clearInterval(f.interval), (R = !1), f.set.labels();
            };
            clearInterval(f.interval), f.bind.transitionEnd(
              t
            ), (R = !0), (f.interval = setInterval(
              function() {
          ...
          labels: function() {
            ...
            ), f.set.barLabel(), f.set.state();
          },
          label: function(e) {
            (e = e || ''), e &&
              ((e = f.get.text(e)), f.verbose(
                'Setting label to text',
                e
              ), S.text(e));
          },
          state: function(e) {
            (e = e !== i ? e : f.percent), 100 === e
              ? m.autoSuccess &&
                  !(f.is.warning() || f.is.error() || f.is.success())
                  ? (f.set.success(), f.debug(
                      'Automatically triggering success at 100%'
                    ))
                  : (f.verbose(
                      'Reached 100% removing active state'
                    ), f.remove.active(), f.remove.progressPoll())
              : e > 0
                  ? (f.verbose(
          ...
          barLabel: function(e) {
            e !== i
              ...
              : 'ratio' == m.label && f.total
                  ? (f.verbose('Adding ratio to bar label'), k.text(
                      f.get.text(m.text.ratio)
                    ))
                  : 'percent' == m.label &&
                      (f.verbose('Adding percentage to bar label'), k.text(
                        f.get.text(m.text.percent)
                      ));
          },
          active: function(e) {
            (e = e || m.text.active), f.debug(
              'Setting active state'
            ), m.showActivity &&
              !f.is.active() &&
              C.addClass(
                g.active
              ), f.remove.warning(), f.remove.error(), f.remove.success(), (e = m.onLabelUpdate(
              'active',
              e,
              f.value,
              f.total
            )), e && f.set.label(e), f.bind.transitionEnd(function() {
              m.onActive.call(T, f.value, f.total);
            });
          },
          success: function(e) {
            (e = e || m.text.success || m.text.active), f.debug(
              'Setting success state'
            ), C.addClass(
              g.success
            ), f.remove.active(), f.remove.warning(), f.remove.error(), f.complete(), m.text.success
              ? ((e = m.onLabelUpdate(
                  'success',
                  e,
                  f.value,
              ...
              : ((e = m.onLabelUpdate(
                  ...
                  f.value,
                  f.total
                )), f.set.label(e)), f.bind.transitionEnd(function() {
              m.onSuccess.call(T, f.total);
            });
          },
          warning: function(e) {
            (e = e || m.text.warning), f.debug(
              'Setting warning state'
            ), C.addClass(
              g.warning
            ), f.remove.active(), f.remove.success(), f.remove.error(), f.complete(), (e = m.onLabelUpdate(
              'warning',
              e,
              f.value,
              f.total
          ...
          error: function(e) {
            (e = e || m.text.error), f.debug('Setting error state'), C.addClass(
              g.error
            ), f.remove.active(), f.remove.success(), f.remove.warning(), f.complete(), (e = m.onLabelUpdate(
              'error',
              e,
              f.value,
              f.total
          ...
          progress: function(e) {
            f.has.progressPoll()
              ...
              : (f.debug(
                  ...
                  e
                ), f.update.progress(e), f.create.progressPoll());
          },
          ...
          toNextValue: function() {
            ...
            e &&
              (f.debug(
                ...
                e
              ), f.update.progress(e), f.remove.nextValue());
          },
          progress: function(e) {
            var t;
            (e = f.get.numericValue(e)), e === !1 &&
              f.error(b.nonNumeric, e), (e = f.get.normalizedValue(
              e
            )), f.has.total()
              ? (f.set.value(e), (t = e / f.total * 100), f.debug(
        ...
        invoke: function(t, n, a) {
          var r, s, l, c = A;
          return (n = n || d), (a = T || a), 'string' == typeof t &&
            c !== i &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(n, o) {
              var a = n != r
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    return o.each(function() {
      ...
      (f = {
        initialize: function() {
          f.verbose('Initializing rating module', m), 0 === k.length &&
            f.setup.layout(), m.interactive
            ? f.enable()
            : f.disable(), f.set.initialLoad(), f.set.rating(
            f.get.initialRating()
          ), f.remove.initialLoad(), f.instantiate();
        },
        instantiate: function() {
        ...
        destroy: function() {
          f.verbose(
            ...
            C
          ), f.remove.events(), w.removeData(y);
        },
        refresh: function() {
          k = w.find(v.icon);
        },
        ...
        event: {
          mouseenter: function() {
            var t = e(this);
            t.nextAll().removeClass(p.selected), w.addClass(
              p.selected
        ...
        enable: function() {
          ...
          ), f.bind.events(), w.removeClass(p.disabled);
        },
        disable: function() {
          f.debug(
            'Setting rating to read-only mode'
          ), f.remove.events(), w.addClass(p.disabled);
        },
        is: {
          initialLoad: function() {
            return d;
        ...
        set: {
          rating: function(e) {
            ...
            w.removeClass(p.selected), k
              .removeClass(p.selected)
              .removeClass(p.active), e > 0 &&
              (f.verbose(
                ...
                .prevAll()
                .addBack()
                .addClass(p.active)), f.is.initialLoad() || m.onRate.call(x, e);
          },
          initialLoad: function() {
            d = !0;
          }
        ...
        invoke: function(t, o, a) {
          var r, s, l, c = C;
          return (o = o || u), (a = x || a), 'string' == typeof t &&
            c !== i &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(n, o) {
              var a = n != r
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.search = function(o) {
    var a,
      r = e(this),
      s = r.selector || '',
      l = new Date().getTime(),
    ...
    return e(this).each(function() {
      ...
      (m = {
        ...
        refresh: function() {
          m.debug('Refreshing selector cache'), (T = S.find(
            y.prompt
          )), (A = S.find(y.searchButton)), (P = S.find(
            y.category
        ...
        bind: {
          events: function() {
            m.verbose('Binding events to search'), g.automatic &&
              (S.on(m.get.inputEvent() + w, y.prompt, m.event.input), T.attr(
                'autocomplete',
                'off'
        ...
        event: {
          input: function() {
            clearTimeout(m.timer), (m.timer = setTimeout(
              m.query,
              g.searchDelay
            ));
          },
          focus: function() {
            m.set.focus(), m.has.minimumCharacters() &&
              (m.query(), m.can.show() && m.showResults());
          },
          blur: function(e) {
            var t = n.activeElement === this,
              i = function() {
                m.cancel.query(), m.remove.focus(), (m.timer = setTimeout(
                  m.hideResults,
                  g.hideDelay
                ));
              };
          ...
          result: {
            ...
            click: function(n) {
              ...
              return e.isFunction(g.onSelect) && g.onSelect.call(F, u, c) === !1
                ...
                : (m.hideResults(), l && m.set.value(l), void (r &&
                    (m.verbose(
          ...
          if (
            ...
            if (l == c.enter) {
              if (
                ...
                return m.event.result.click.call(
                  n.filter('.' + p.active),
                  e
                ), e.preventDefault(), !1;
            } else
              l == c.upArrow && s
                ? (m.verbose('Up key pressed, changing active result'), (t = a -
                    1 <
                    0
                    ? a
                    : a - 1), i.removeClass(p.active), n
            ...
            l == c.enter &&
              ...
              ), m.query(), m.set.buttonPressed(), T.one(
                'keyup',
                m.remove.buttonFocus
              ));
        },
        setup: {
          api: function(t) {
            ...
            e.extend(!0, n, g.apiSettings), m.verbose(
        ...
        trigger: {
          blur: function() {
            ...
            t &&
              (m.verbose('Triggering native blur event'), e.initEvent(
                'blur',
                !1,
                !1
              ), t.dispatchEvent(e));
        ...
        get: {
          ...
          result: function(t, n) {
            var o = ['title', 'id'], a = !1;
            return (t = t !== i ? t : m.get.value()), (n = n !== i
              ? n
              : m.get.results()), 'category' === g.type
              ? (m.debug(
        ...
        query: function() {
          ...
          m.has.minimumCharacters()
            ? (n
                ? (m.debug('Reading result from cache', t), m.save.results(
                    n.results
                  ), m.addResults(n.html), m.inject.id(n.results))
                : (m.debug('Querying for', t), e.isPlainObject(g.source) ||
                    e.isArray(g.source)
                    ? m.search.local(t)
                    : m.can.useAPI()
                        ? m.search.remote(t)
                        : m.error(x.source)), g.onSearchQuery.call(F, t))
            : m.hideResults();
        },
        search: {
          local: function(e) {
            var t, n = m.search.object(e, g.content);
            m.set.loading(), m.save.results(n), m.debug(
              'Returned local search results',
              n
            ), (t = m.generateResults({
              results: n
            })), m.remove.loading(), m.addResults(t), m.inject.id(
              n
            ), m.write.cache(e, { html: t, results: n });
          },
          remote: function(e) {
            S.api('is loading') && S.api('abort'), m.setup.api(e), S.api(
              'query'
            );
          },
          object: function(t, n, o) {
            ...
            return (n = n || g.source), (o = o !== i
              ? o
              : g.searchFields), e.isArray(o) || (o = [o]), n === i || n === !1
              ? (m.error(x.source), [])
        ...
        parse: {
          response: function(e, t) {
            ...
            m.verbose('Parsing server response', e), e !== i &&
              t !== i &&
              e[b.results] !== i &&
              (m.addResults(n), m.inject.id(e[b.results]), m.write.cache(t, {
                html: n,
                results: e[b.results]
          ...
          cache: function(e) {
            ...
            e
              ? e &&
                  t &&
                  t[e] &&
                  (m.debug('Removing value from cache', e), delete t[e], S.data(
                    h.cache,
                    t
                  ))
        ...
        create: {
          id: function(e, t) {
            var n, o, a = e + 1;
            return t !== i
              ? ((n = String.fromCharCode(97 + t)), (o = n + a), m.verbose(
                  'Creating category result id',
                  o
                ))
              : ((o = a), m.verbose('Creating result id', o)), o;
          },
          results: function() {
            0 === R.length &&
        ...
        inject: {
          ...
          id: function(t) {
            ...
            var n = 0, o = 0;
            return 'category' === g.type
              ? e.each(t, function(t, a) {
                  (o = 0), e.each(a.results, function(e, t) {
                    var r = a.results[e];
                    r.id === i &&
                      (r.id = m.create.id(o, n)), m.inject.result(r, o, n), o++;
                  }), n++;
                })
              : e.each(t, function(e, n) {
                  var a = t[e];
                  a.id === i &&
                    (a.id = m.create.id(o)), m.inject.result(a, o), o++;
                }), t;
          }
        },
        save: {
          results: function(e) {
            m.verbose('Saving current search results to metadata', e), S.data(
              h.results,
              e
            );
          }
        ...
        write: {
          cache: function(e, t) {
            ...
            g.cache &&
              (m.verbose('Writing generated html to cache', e, t), (n[
                e
              ] = t), S.data(h.cache, n));
          }
        },
        addResults: function(t) {
          return e.isFunction(g.onResultsAdd) &&
            ...
            : void (t
                ? (R.html(t), m.refreshResults(), g.selectFirstResult &&
                    m.select.firstResult(), m.showResults())
                : m.hideResults());
        },
        showResults: function() {
          m.is.visible() ||
            (m.can.transition()
              ? (m.debug('Showing results with css animations'), R.transition({
                  animation: g.transition + ' in',
                  debug: g.debug,
                  verbose: g.verbose,
                  duration: g.duration,
              ...
              : (m.debug('Showing results with javascript'), R.stop().fadeIn(
                  g.duration,
                  g.easing
        ...
        hideResults: function() {
          m.is.visible() &&
            (m.can.transition()
              ? (m.debug('Hiding results with css animations'), R.transition({
                  animation: g.transition + ' out',
                  debug: g.debug,
                  verbose: g.verbose,
                  duration: g.duration,
              ...
              : (m.debug('Hiding results with javascript'), R.stop().fadeOut(
                  g.duration,
                  g.easing
        ...
        generateResults: function(t) {
          ...
          return i || o
            ...
            : g.showNoResults &&
                (a = m.displayMessage(x.noResults, 'empty')), g.onResults.call(
            F,
            t
          ), a;
        },
        displayMessage: function(e, t) {
          return (t = t || 'standard'), m.debug(
            'Displaying message',
            e,
            t
          ), m.addResults(g.templates.message(e, t)), g.templates.message(e, t);
        },
        setting: function(t, n) {
          if (e.isPlainObject(t))
            e.extend(!0, g, t);
        ...
        performance: {
          ...
          display: function() {
            ...
            (l = !1), clearTimeout(
              ...
              n += t['Execution Time'];
            }), (t += ' ' + n + 'ms'), s && (t += " '" + s + "'"), r.length >
              1 && (t += ' (' + r.length + ')'), (console.group !== i ||
              console.table !== i) &&
              c.length > 0 &&
              (console.groupCollapsed(t), console.table
                ? console.table(c)
        ...
        invoke: function(t, n, o) {
          var r, s, l, c = O;
          return (n = n || f), (o = F || o), 'string' == typeof t &&
            c !== i &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(n, o) {
              var a = n != r
      ...
      category: function(t, n) {
        ...
        return t[n.categoryResults] !== i &&
          (e.each(t[n.categoryResults], function(t, a) {
            a[n.results] !== i &&
              a.results.length > 0 &&
              ((o += '<div class="category">'), a[n.categoryName] !== i &&
                (o += '<div class="name">' +
                  a[n.categoryName] +
                  '</div>'), e.each(a.results, function(e, t) {
                (o += t[n.url]
                  ? '<a class="result" href="' + t[n.url] + '">'
                  : '<a class="result">'), t[n.image] !== i && (o += '<div class="image"> <img src="' + t[n.image] + '"></div>'), (o += '<div class="content">'), t[n.price] !== i && (o += '<div class="price">' + t[n.price] + '</div>'), t[n.title] !== i && (o += '<div class="title">' + t[n.title] + '</div>'), t[n.description] !== i && (o += '<div class="description">' + t[n.description] + '</div>'), (o += '</div>'), (o += '</a>');
              }), (o += '</div>'));
          }), t[n.action] &&
            (o += '<a href="' +
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.shape = function(o) {
    var a,
      r = e(this),
      ...
      (g = {
        initialize: function() {
          g.verbose(
            ...
            R
          ), g.set.defaultSide(), g.instantiate();
        },
        instantiate: function() {
          g.verbose('Storing instance of module', g), (E = g), k.data(w, E);
        },
        destroy: function() {
          g.verbose('Destroying previous module for', R), k
            .removeData(w)
            .off(C);
        },
        refresh: function() {
          g.verbose('Refreshing selector cache for', R), (k = e(R)), (S = e(
            this
          ).find(b.shape)), (T = e(this).find(b.side));
        },
        repaint: function() {
        ...
        animate: function(e, n) {
          g.verbose('Animating box with properties', e), (n = n ||
            function(e) {
              g.verbose('Executing animation callback'), e !== i &&
                e.stopPropagation(), g.reset(), g.set.active();
            }), h.beforeChange.call(m[0]), g.get.transitionEvent()
            ? (g.verbose('Starting CSS animation'), k.addClass(
                x.animating
              ), S.css(e).one(g.get.transitionEvent(), n), g.set.duration(
                h.duration
              ), f(function() {
        ...
        queue: function(e) {
          g.debug(
            ...
            g.debug('Executing queued animation'), setTimeout(
              function() {
                k.shape(e);
              },
              0
        ...
        reset: function() {
          g.verbose('Animating states reset'), k
            .removeClass(x.animating)
            .attr('style', '')
            .removeAttr('style'), S.attr('style', '').removeAttr(
            'style'
          ), T.attr('style', '')
            .removeAttr('style')
            .removeClass(x.hidden), m
            .removeClass(x.animating)
            .attr('style', '')
            .removeAttr('style');
        },
        ...
        set: {
          defaultSide: function() {
            (t = k.find('.' + h.className.active)), (m = t.next(b.side).length >
              0
              ? t.next(b.side)
              : k.find(b.side).first()), (A = !1), g.verbose(
              'Active side set to',
              t
            ), g.verbose('Next side set to', m);
          },
          duration: function(e) {
            (e = e || h.duration), (e = 'number' == typeof e
              ? e + 'ms'
              : e), g.verbose('Setting animation duration', e), (h.duration ||
              0 === h.duration) &&
              S.add(T).css({
          ...
          stageSize: function() {
            var e = k.clone().addClass(x.loading),
              ...
              i = 'next' == h.width
                ? n.outerWidth(!0)
                : 'initial' == h.width ? k.width() : h.width,
              o = 'next' == h.height
                ? n.outerHeight(!0)
                : 'initial' == h.height ? k.height() : h.height;
            t.removeClass(x.active), n.addClass(x.active), e.insertAfter(
              k
            ), e.remove(), 'auto' != h.width &&
              (k.css('width', i + h.jitter), g.verbose(
                'Specifying width during animation',
                i
              )), 'auto' != h.height &&
              (k.css('height', o + h.jitter), g.verbose(
                'Specifying height during animation',
                o
              ));
          },
          nextSide: function(e) {
            (A = e), (m = T.filter(e)), (A = T.index(m)), 0 === m.length &&
              (g.set.defaultSide(), g.error(y.side)), g.verbose(
              'Next side manually set to',
              m
            );
          },
          active: function() {
            g.verbose('Setting new side to active', m), T.removeClass(
              x.active
            ), m.addClass(x.active), h.onChange.call(m[0]), g.set.defaultSide();
          }
        },
        flip: {
          up: function() {
            ...
            return !g.is.complete() || g.is.animating() || h.allowRepeats
              ? void (g.is.animating()
                  ...
                  : (g.debug(
                      'Flipping over',
                      m
                    ), g.set.stageSize(), g.stage.behind(), g.animate(
                      g.get.transform.over()
                    )))
        ...
        stage: {
          ...
          behind: function() {
            ...
            g.verbose(
              ...
              m,
              n
            ), t.css({ transform: 'rotateY(0deg)' }), m
              .addClass(x.animating)
        ...
        invoke: function(t, n, o) {
          var r, s, l, c = E;
          return (n = n || d), (o = R || o), 'string' == typeof t &&
            c !== i &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(n, o) {
              var a = n != r
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.sidebar = function(o) {
    var a,
      r = e(this),
      s = e(t),
      l = e(n),
      ...
      (w = {
        initialize: function() {
          w.debug(
            ...
            o
          ), w.create.id(), (C = w.get.transitionEvent()), w.is.ios() &&
            w.set.ios(), k.delaySetup
            ? v(w.setup.layout)
        ...
        create: {
          id: function() {
            (y = (Math.random().toString(16) + '000000000').substr(
              2,
              8
            )), (b = '.' + y), w.verbose('Creating unique id for element', y);
          }
        },
        destroy: function() {
          w.verbose('Destroying previous module for', O), O.off(P).removeData(
            F
          ), w.is.ios() && w.remove.ios(), D.off(b), s.off(b), l.off(b);
        },
        event: {
          clickaway: function(e) {
            var t = z.find(e.target).length > 0 || z.is(e.target),
              n = D.is(e.target);
            t && (w.verbose('User clicked on dimmed page'), w.hide()), n &&
              (w.verbose(
          ...
          containScroll: function(e) {
            M.scrollTop <= 0 && (M.scrollTop = 1), M.scrollTop +
              M.offsetHeight >=
              M.scrollHeight &&
        ...
        bind: {
          clickaway: function() {
            w.verbose('Adding clickaway events to context', D), k.closable &&
          ...
          scrollLock: function() {
            k.scrollLock &&
              (w.debug('Disabling page scroll'), s.on(
                'DOMMouseScroll' + b,
                w.event.scroll
              )), w.verbose('Adding events to contain sidebar scroll'), l.on(
              'touchmove' + b,
              w.event.touch
        ...
        unbind: {
          ...
          scrollLock: function() {
            w.verbose('Removing scroll lock from page'), l.off(b), s.off(
              b
            ), O.off('scroll' + P);
          }
        },
        add: {
          inlineCSS: function() {
            ...
            o &&
              (w.verbose(
                'RTL detected, flipping widths'
              ), (s.left = -n), (s.right = n)), (t = '<style>'), 'left' === a ||
              'right' === a
              ? (w.debug(
              ...
              ('left' === a || 'right' === a
                ...
                : ('top' !== a && 'bottom' != a) ||
                    (t += ' body.pushable > .ui.visible.' +
                      ...
                      'px, 0);           transform: translate3d(0, ' +
                      s[a] +
                      'px, 0); }'), (t += ' body.pushable > .ui.visible.left.sidebar ~ .ui.visible.right.sidebar ~ .pusher:after, body.pushable > .ui.visible.right.sidebar ~ .ui.visible.left.sidebar ~ .pusher:after {   -webkit-transform: translate3d(0px, 0, 0);           transform: translate3d(0px, 0, 0); }')), (t += '</style>'), (r = e(
              t
            ).appendTo(u)), w.debug('Adding sizing css to head', r);
          }
        },
        refresh: function() {
          w.verbose('Refreshing selector cache'), (D = e(
            k.context
          )), (q = D.children(S.sidebar)), (z = D.children(
            S.pusher
          )), (j = D.children(S.fixed)), w.clear.cache();
        },
        ...
        setup: {
          ...
          layout: function() {
            0 === D.children(S.pusher).length &&
              (w.debug('Adding wrapper element for sidebar'), w.error(
                E.pusher
              ), (z = e('<div class="pusher" />')), D.children()
                .not(S.omitted)
                .not(q)
                .wrapAll(z), w.refresh()), (0 !== O.nextAll(S.pusher).length &&
              O.nextAll(S.pusher)[0] === z[0]) ||
              (w.debug('Moved sidebar to correct parent element'), w.error(
                E.movedSidebar,
                M
              ), O.detach().prependTo(
                D
              ), w.refresh()), w.clear.cache(), w.set.pushable(), w.set.direction();
          }
        },
        attachEvents: function(t, n) {
          var i = e(t);
          (n = e.isFunction(w[n]) ? w[n] : w.toggle), i.length > 0
            ? (w.debug('Attaching sidebar events to element', t, n), i.on(
                'click' + P,
                n
              ))
        ...
        show: function(t) {
          if (((t = e.isFunction(t) ? t : function() {}), w.is.hidden())) {
            if (
              (w.refreshSidebars(), k.overlay &&
                (w.error(
                  E.overlay
                ), (k.transition = 'overlay')), w.refresh(), w.othersActive())
            )
        ...
        hide: function(t) {
          (t = e.isFunction(t) ? t : function() {}), (w.is.visible() ||
            w.is.animating()) &&
            (w.debug(
              'Hiding sidebar',
              t
            ), w.refreshSidebars(), w.pullPage(function() {
        ...
        toggle: function() {
          w.verbose('Determining toggled direction'), w.is.hidden()
            ? w.show()
            : w.hide();
        },
        pushPage: function(t) {
          ...
          (t = e.isFunction(t) ? t : function() {}), 'scale down' ==
            k.transition && w.scrollToTop(), w.set.transition(
            a
            ...
            e.target == r[0] &&
              (r.off(
                C + b,
                o
              ), w.remove.animating(), w.bind.scrollLock(), t.call(M));
          }), r.off(C + b), r.on(C + b, o), v(n), k.dimPage &&
            !w.othersVisible() &&
            v(i);
        },
        pullPage: function(t) {
          ...
          (t = e.isFunction(t) ? t : function() {}), w.verbose(
            ...
            w.get.direction()
          ), w.unbind.clickaway(), w.unbind.scrollLock(), (n = function() {
            w.set.transition(
              o
            ), w.set.animating(), w.remove.visible(), k.dimPage &&
              !w.othersVisible() &&
            ...
            e.target == a[0] &&
              (a.off(
                C + b,
                i
              ), w.remove.animating(), w.remove.transition(), w.remove.inlineCSS(), ('scale down' ==
                o ||
                (k.returnScroll && w.is.mobile())) &&
                w.scrollBack(), t.call(M));
          }), a.off(C + b), a.on(C + b, i), v(n);
        },
        scrollToTop: function() {
          w.verbose(
            'Scrolling to top of page to avoid animation issues'
          ), (x = e(t).scrollTop()), O.scrollTop(0), t.scrollTo(0, 0);
        },
        scrollBack: function() {
          w.verbose('Scrolling back to original page position'), t.scrollTo(
            0,
            x
          );
        },
        ...
        remove: {
          inlineCSS: function() {
            w.debug('Removing inline css styles', r), r &&
              r.length > 0 &&
              r.remove();
          },
          ios: function() {
        ...
        is: {
          ...
          rtl: function() {
            return w.cache.rtl === i &&
              (w.cache.rtl = 'rtl' == O.css('direction')), w.cache.rtl;
          }
        },
        setting: function(t, n) {
        ...
        invoke: function(t, n, o) {
          var r, s, l, c = I;
          return (n = n || h), (o = M || o), 'string' == typeof t &&
            c !== i &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(n, o) {
              var a = n != r
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.sticky = function(o) {
    var a,
      r = e(this),
      s = r.selector || '',
      l = new Date().getTime(),
      ...
      (h = {
        initialize: function() {
          h.determineContainer(), h.determineContext(), h.verbose(
            ...
            v,
            r
          ), h.save.positions(), h.checkErrors(), h.bind.events(), v.observeChanges &&
            h.observeChanges(), h.instantiate();
        },
        instantiate: function() {
          h.verbose('Storing instance of module', h), (A = h), k.data(w, h);
        },
        destroy: function() {
          h.verbose('Destroying previous instance'), h.reset(), g &&
            g.disconnect(), p && p.disconnect(), S.off(
            'load' + C,
            h.event.load
          ).off('resize' + C, h.event.resize), T.off(
            'scrollchange' + C,
        ...
        observeChanges: function() {
          'MutationObserver' in t &&
            ((g = new MutationObserver(
              h.event.documentChanged
            )), (p = new MutationObserver(h.event.changed)), g.observe(n, {
              childList: !0,
              subtree: !0
        ...
        checkErrors: function() {
          if (
            (h.is.hidden() && h.error(x.visible, k), h.cache.element.height >
        ...
        event: {
          changed: function(e) {
            clearTimeout(h.timer), (h.timer = setTimeout(
              function() {
                h.verbose(
        ...
        refresh: function(e) {
          h.reset(), v.context || h.determineContext(), e &&
            h.determineContainer(), h.save.positions(), h.stick(), v.onReposition.call(
            E
          );
        },
        supports: {
        ...
        save: {
          ...
          positions: function() {
            ...
            h.is.standardScroll() ||
              ...
              ), (e.top = T.scrollTop()), (e.left = T.scrollLeft()), (t.offset.top += e.top), (n.offset.top += e.top), (t.offset.left += e.left), (n.offset.left += e.left)), (h.cache = {
            ...
            }), h.set.containerSize(), h.set.size(), h.stick(), h.debug(
        ...
        get: {
          direction: function(e) {
            var t = 'down';
            return (e = e || T.scrollTop()), h.lastScroll !== i &&
              (h.lastScroll < e
                ? (t = 'down')
                : h.lastScroll > e && (t = 'up')), t;
          },
          scrollChange: function(e) {
            return (e = e || T.scrollTop()), h.lastScroll
              ? e - h.lastScroll
              : 0;
          },
        ...
        set: {
          offset: function() {
            h.verbose('Setting offset on element', v.offset), k.css(
              'margin-top',
              v.offset
            );
          },
          ...
          scroll: function(e) {
            h.debug('Setting scroll on element', e), h.elementScroll != e &&
              (h.is.top() &&
                k.css('bottom', '').css('top', -e), h.is.bottom() &&
        ...
        bindTop: function() {
          h.debug(
            ...
            .addClass(b.bound)
            .addClass(b.top), v.onTop.call(E), v.onUnstick.call(E);
        },
        bindBottom: function() {
          h.debug(
            ...
            .removeClass(b.top)
            .addClass(b.bound)
            .addClass(b.bottom), v.onBottom.call(E), v.onUnstick.call(E);
        },
        ...
        fixTop: function() {
          h.debug(
            'Fixing element to top of page'
          ), h.set.minimumSize(), h.set.offset(), k
            .css({ left: h.cache.element.left, bottom: '', marginBottom: '' })
            .removeClass(b.bound)
            .removeClass(b.bottom)
            .addClass(b.fixed)
            .addClass(b.top), v.onStick.call(E);
        },
        fixBottom: function() {
          h.debug(
            'Sticking element to bottom of page'
          ), h.set.minimumSize(), h.set.offset(), k
            .css({ left: h.cache.element.left, bottom: '', marginBottom: '' })
            .removeClass(b.bound)
            .removeClass(b.top)
            .addClass(b.fixed)
            .addClass(b.bottom), v.onStick.call(E);
        },
        unbind: function() {
          h.is.bound() &&
            (h.debug(
        ...
        unfix: function() {
          h.is.fixed() &&
            (h.debug(
              'Removing fixed position on element'
            ), h.remove.offset(), k
              .removeClass(b.fixed)
              .removeClass(b.top)
              .removeClass(b.bottom), v.onUnstick.call(E));
        },
        reset: function() {
          h.debug(
            'Resetting elements position'
          ), h.unbind(), h.unfix(), h.resetCSS(), h.remove.offset(), h.remove.lastScroll();
        },
        resetCSS: function() {
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.tab = function(o) {
    var a,
      ...
      (b = {
        initialize: function() {
          b.debug(
            ...
            R
          ), b.fix.callbacks(), b.determineTabs(), b.debug(
            'Determining tabs',
            x.context,
            p
          ), x.auto && b.set.auto(), b.bind.events(), x.history &&
            !m &&
            (b.initializeHistory(), (m = !0)), b.instantiate();
        },
        instantiate: function() {
        ...
        bind: {
          events: function() {
            e.isWindow(O) ||
              (b.debug('Attaching tab activation events to element', R), R.on(
                'click' + T,
                b.event.click
              ));
          }
        ...
        fix: {
          callbacks: function() {
            e.isPlainObject(o) &&
              ...
              (o.onTabLoad &&
                ((o.onLoad = o.onTabLoad), delete o.onTabLoad, b.error(
                  S.legacyLoad,
                  o.onLoad
                )), o.onTabInit &&
                ((o.onFirstLoad = o.onTabInit), delete o.onTabInit, b.error(
                  S.legacyInit,
                  o.onFirstLoad
          ...
          click: function(t) {
            ...
            n !== i
              ? (x.history
                  ...
                  : (b.verbose('Changing tab', t), b.changeTab(
                      n
                    )), t.preventDefault())
        ...
        cache: {
          ...
          remove: function(e) {
            (e = e || h), b.debug('Removing cached content for', e), delete E[
              e
            ];
          }
        },
        set: {
          ...
          loading: function(e) {
            ...
            n ||
              (b.verbose('Setting loading state for', t), t
                .addClass(C.loading)
                .siblings(p)
                .removeClass(C.active + ' ' + C.loading), t.length > 0 &&
                x.onRequest.call(t[0], e));
          },
          state: function(t) {
            e.address.value(t);
          }
            ...
            if ((b.verbose('Looking for tab', i), m)) {
              if (
                (b.verbose(
                  'Tab was found',
                  i
                ), (h = f), (v = b.utilities.filterArray(r, d)), p
                  ? (u = !0)
                  : ((l = r.slice(0, t + 2)), (c = b.utilities.arrayToPath(
                      l
                    )), (u = !b.is.tab(c)), u &&
                      b.verbose('Tab parameters found', l)), u && a)
              )
                return o
                  ? (b.debug(
                      'Ignoring remote content on first tab load',
                      f
                    ), (P = !1), b.cache.add(n, k.html()), b.activate.all(
                      f
                    ), x.onFirstLoad.call(k[0], f, v, y), x.onLoad.call(
                      k[0],
                      f,
                      v,
                      y
                    ))
                  : (b.activate.navigation(f), b.fetch.content(f, n)), !1;
              b.debug('Opened local tab', f), b.activate.all(f), b.cache.read(
                f
              ) ||
                (b.cache.add(f, !0), b.debug(
              ...
              if (
                ((s = e('#' + n + ', a[name="' + n + '"]')), (f = s
                  .closest('[data-tab]')
                  .data(w.tab)), (k = b.get.tabElement(f)), s &&
                  s.length > 0 &&
                  f)
              )
                return b.debug(
                  ...
                  setTimeout(
                    ...
                    0
                  ), b.activate.all(f), b.cache.read(f) ||
                  (b.cache.add(f, !0), b.debug(
                    'First time tab loaded calling tab init'
                  ), x.onFirstLoad.call(k[0], f, v, y)), x.onLoad.call(
                  k[0],
        ...
        update: {
          content: function(t, n, o) {
            ...
            (o = o !== i ? o : x.evaluateScripts), 'string' ==
              typeof x.cacheType &&
        ...
        fetch: {
          content: function(t, n) {
            var o,
              ...
              s = {
                ...
                onSuccess: function(e) {
                  'response' == x.cacheType &&
                    b.cache.add(n, e), b.update.content(t, e), t == h
                    ? (b.debug('Content loaded', t), b.activate.tab(t))
                    : b.debug(
                        'Content loaded in background',
                        t
                      ), x.onFirstLoad.call(r[0], t, v, y), x.onLoad.call(
                    r[0],
                    t,
                    v,
                    y
              ...
              c = l && 'pending' === l.state();
            (n = n || t), (a = b.cache.read(n)), x.cache && a
              ? (b.activate.tab(t), b.debug(
                  'Adding cached content',
                  n
                ), 'once' == x.evaluateScripts
                  ? b.update.content(t, a, !1)
                  : b.update.content(t, a), x.onLoad.call(r[0], t, v, y))
              : c
                  ? (b.set.loading(t), b.debug('Content is already loading', n))
                  : e.api !== i
                      ? ((o = e.extend(!0, {}, x.apiSettings, s)), b.debug(
                          'Retrieving remote content',
                          n,
                          o
                        ), b.set.loading(t), r.api(o))
                      : b.error(S.api);
          }
        },
        activate: {
          ...
          tab: function(e) {
            ...
            b.verbose('Showing tab content for', t), i ||
              (t.addClass(C.active), n.removeClass(
                C.active + ' ' + C.loading
          ...
          navigation: function(e) {
            var t = b.get.navElement(e),
              ...
              i = t.hasClass(C.active);
            b.verbose('Activating tab navigation for', t, e), i ||
        ...
        get: {
          ...
          tabElement: function(e) {
            var t, n, i, o;
            return (e = e || h), (i = b.utilities.pathToArray(
              e
            )), (o = b.utilities.last(i)), (t = p.filter(
              '[data-' + w.tab + '="' + e + '"]'
            )), (n = p.filter('[data-' + w.tab + '="' + o + '"]')), t.length > 0
              ? t
              : n;
          },
          tab: function() {
        ...
        utilities: {
          ...
          pathToArray: function(e) {
            return e === i && (e = h), 'string' == typeof e
              ? e.split('/')
              : [e];
          },
        ...
        invoke: function(t, n, o) {
          var r, s, l, c = D;
          return (n = n || f), (o = O || o), 'string' == typeof t &&
            c !== i &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(n, o) {
              var a = n != r
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    return a.each(function(t) {
      ...
      (C = {
        initialize: function() {
          (m = C.get.settings.apply(
            k,
            c
          )), (h = m.className), (p = m.error), (v = m.metadata), (x = '.' +
            m.namespace), (y = 'module-' + m.namespace), (g = w.data(y) ||
            C), (b = C.get.animationEndEvent()), f && (f = C.invoke(u)), f ===
            !1 &&
            (C.verbose(
              'Converted arguments into settings object',
              m
            ), m.interval ? C.delay(m.animate) : C.animate(), C.instantiate());
        },
        instantiate: function() {
        ...
        delay: function(e) {
          ...
          r ||
            (r = C.can.transition() ? C.get.direction() : 'static'), (e = e !==
            i
            ? e
            : m.interval), (n = 'auto' == m.reverse &&
            r == h.outward), (o = n || 1 == m.reverse
            ? (a.length - t) * m.interval
            : t * m.interval), C.debug('Delaying animation by', o), setTimeout(
            C.animate,
            o
          );
        },
        ...
        reset: function() {
          ...
          ), C.remove.animationCallbacks(), C.restore.conditions(), C.remove.animating();
        },
        queue: function(e) {
          C.debug('Queueing animation of', e), (C.queuing = !0), w.one(
            b + '.queue' + x,
            function() {
        ...
        complete: function(e) {
          C.debug(
            'Animation complete',
            m.animation
          ), C.remove.completeCallback(), C.remove.failSafe(), C.is.looping() ||
            (C.is.outward()
              ? (C.verbose(
                  'Animation is outward, hiding element'
                ), C.restore.conditions(), C.hide())
              : C.is.inward()
                  ? (C.verbose(
                      'Animation is outward, showing element'
                    ), C.restore.conditions(), C.show())
                  : (C.verbose(
                      'Static animation completed'
                    ), C.restore.conditions(), m.onComplete.call(k)));
        },
        force: {
          visible: function() {
            var e = w.attr('style'),
          ...
          hidden: function() {
            ...
            'none' === t || C.is.hidden()
              ...
              : (C.verbose('Overriding default display to hide element'), w.css(
                  'display',
                  'none'
                ));
          }
        ...
        has: {
          direction: function(t) {
            var n = !1;
            return (t = t || m.animation), 'string' == typeof t &&
              ((t = t.split(' ')), e.each(t, function(e, t) {
        ...
        set: {
          animating: function(e) {
            var t;
            C.remove.completeCallback(), (e = e ||
              m.animation), (t = C.get.animationClass(e)), C.save.animation(
              t
            ), C.force.visible(), C.remove.hidden(), C.remove.direction(), C.start.animation(
              t
            );
          },
          duration: function(e, t) {
            (t = t || m.duration), (t = 'number' == typeof t
              ? t + 'ms'
              : t), (t || 0 === t) &&
              (C.verbose('Setting animation duration', t), w.css({
                'animation-duration': t
              }));
          },
          direction: function(e) {
            (e = e || C.get.direction()), e == h.inward
              ? C.set.inward()
              : C.set.outward();
          },
          looping: function() {
          ...
          inward: function() {
            C.debug('Setting direction to inward'), w
              .removeClass(h.outward)
              .addClass(h.inward);
          },
          outward: function() {
            C.debug('Setting direction to outward'), w
        ...
        start: {
          animation: function(e) {
            (e = e || C.get.animationClass()), C.debug(
              'Starting tween',
              e
            ), w
              .addClass(e)
              .one(b + '.complete' + x, C.complete), m.useFailSafe &&
              C.add.failSafe(), C.set.duration(m.duration), m.onStart.call(k);
          }
        },
        save: {
          animation: function(e) {
          ...
          transitionExists: function(t, n) {
            (e.fn.transition.exists[t] = n), C.verbose(
        ...
        remove: {
          ...
          failSafe: function() {
            C.verbose('Removing fail safe timer', C.timer), C.timer &&
          ...
          looping: function() {
            C.debug('Transitions are no longer looping'), C.is.looping() &&
              (C.reset(), w.removeClass(h.looping));
          },
          transition: function() {
        ...
        get: {
          ...
          animationClass: function(e) {
            var t = e || m.animation,
              n = C.can.transition() && !C.has.direction()
                ? C.get.direction() + ' '
                : '';
          ...
          duration: function(e) {
            return (e = e || m.duration), e === !1 &&
              (e = w.css('animation-duration') || 0), 'string' == typeof e
              ? e.indexOf('ms') > -1 ? parseFloat(e) : 1e3 * parseFloat(e)
              : e;
          },
          displayType: function(e) {
            return (e = e === i || e), m.displayType
              ? m.displayType
              : (e &&
                  w.data(v.displayType) === i &&
                  C.can.transition(!0), w.data(v.displayType));
          },
          userStyle: function(e) {
            return (e = e || w.attr('style') || ''), e.replace(
              /display.*?;/,
              ''
            );
          },
        ...
        can: {
          transition: function(t) {
            ...
            if (u === i || t) {
              if (
                (C.verbose('Determining whether animation exists'), (n = w.attr(
                  'class'
                )), (o = w.prop('tagName')), (a = e('<' + o + ' />')
                  .addClass(n)
                  .insertAfter(w)), (r = a
                  .addClass(c)
                  .removeClass(h.inward)
                  ...
                  ((d = a
                    ...
                    .show()
                    .css('display')), C.verbose(
                    'Determining final display state',
                    d
                  ), C.save.displayType(d)), a.remove(), r != s)
              )
        ...
        is: {
          ...
          occurring: function(e) {
            return (e = e || m.animation), (e = '.' +
              e.replace(' ', '.')), w.filter(e).length > 0;
          },
          visible: function() {
            return w.is(':visible');
          },
        ...
        hide: function() {
          C.verbose('Hiding element'), C.is.animating() &&
            C.reset(), k.blur(), C.remove.display(), C.remove.visible(), C.set.hidden(), C.force.hidden(), m.onHide.call(
            k
          ), m.onComplete.call(k);
        },
        show: function(e) {
          C.verbose(
            'Showing element',
            e
          ), C.remove.hidden(), C.set.visible(), C.force.visible(), m.onShow.call(
            k
          ), m.onComplete.call(k);
        },
        toggle: function() {
        ...
        stopAll: function() {
          ...
          ), C.remove.queueCallback(), w.triggerHandler(b);
        },
        clear: {
          queue: function() {
        ...
        invoke: function(t, n, a) {
          var r, s, l, c = g;
          return (n = n || d), (a = k || a), 'string' == typeof t &&
            c !== i &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(n, o) {
              var a = n != r
  ...
  'use strict';
  var t = 'undefined' != typeof t && t.Math == Math
    ? t
    : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')();
  (e.api = (e.fn.api = function(n) {
    ...
    return a.each(function() {
      ...
      (h = {
        ...
        destroy: function() {
          h.verbose('Destroying previous module for', E), T.removeData(S).off(
            k
          );
        },
        bind: {
          events: function() {
            var e = h.get.event();
            e
              ? (h.verbose('Attaching API events to element', e), T.on(
                  e + k,
                  h.event.trigger
                ))
              : 'now' == v.on &&
        ...
        read: {
          cachedResponse: function(e) {
            ...
            return t.Storage === i
              ...
              : ((n = sessionStorage.getItem(e)), h.debug(
          ...
          cachedResponse: function(n, o) {
            return o && '' === o
              ...
              : t.Storage === i
                  ? void h.error(C.noStorage)
                  : (e.isPlainObject(o) &&
                      (o = JSON.stringify(o)), sessionStorage.setItem(
                      n,
                      o
        ...
        query: function() {
          ...
          return v.defaultData &&
            e.extend(!0, v.urlData, h.get.defaultData()), v.serializeForm &&
            (v.data = h.add.formData(v.data)), (f = h.get.settings()), f === !1
            ? ((h.cancelled = !0), void h.error(C.beforeSend))
            : ((h.cancelled = !1), (m = h.get.templatedURL()), m ||
                h.is.mocked()
                ? ((m = h.add.urlData(m)), m || h.is.mocked()
                    ? ((f.url = v.base + m), (a = e.extend(!0, {}, v, {
                        ...
                        failure: function() {},
                        complete: function() {}
                      })), h.debug('Querying URL', a.url), h.verbose(
                        'Using AJAX settings',
                        a
                      ), 'local' === v.cache && h.read.cachedResponse(m)
                        ? (h.debug(
                            'Response returned from local cache'
                          ), (h.request = h.create.request()), void h.request.resolveWith(
                            P,
                        ...
                        : void (v.throttle
                            ? v.throttleFirstRequest || h.timer
                                ? (h.debug(
                                    ...
                                    function() {
                                      h.timer && delete h.timer, h.debug(
                                ...
                                : (h.debug(
                                    ...
                                    g,
                                    a.method
                                  ), h.send.request(), (h.timer = setTimeout(
                                    function() {},
                                    v.throttle
                                  )))
                            : (h.debug(
        ...
        add: {
          urlData: function(t, n) {
            var o, a;
            return t &&
              ((o = t.match(v.regExp.required)), (a = t.match(
                v.regExp.optional
              )), (n = n || v.urlData), o &&
                (h.debug(
                  ...
                  var r = a.indexOf('$') !== -1
                    ...
                    s = e.isPlainObject(n) && n[r] !== i
                      ? n[r]
                      : T.data(r) !== i
                          ? T.data(r)
                          : R.data(r) !== i ? R.data(r) : n[r];
                  return s === i
          ...
          formData: function(t) {
            ...
            return (t = t || v.data), (n = e.isPlainObject(t)), n
              ? o
                  ...
                  : (h.error(C.missingSerialize), h.debug(
                      'Cant extend data. Replacing data with form data',
                      t,
                      a
                    ), (t = a))
              : (h.debug('Adding form data', a), (t = a)), t;
          }
        },
        send: {
          request: function() {
            h.set.loading(), (h.request = h.create.request()), h.is.mocked()
              ? (h.mockedXHR = h.create.mockedXHR())
              : (h.xhr = h.create.xhr()), v.onRequest.call(P, h.request, h.xhr);
          }
        },
        event: {
          trigger: function(e) {
            h.query(), ('submit' != e.type && 'click' != e.type) ||
              e.preventDefault();
          },
          xhr: {
            always: function() {},
          ...
          request: {
              ...
              h.debug('Successful API Response', e), 'local' === v.cache &&
                m &&
                (h.write.cachedResponse(m, e), h.debug(
            ...
            complete: function(e, t) {
              ...
              h.was.succesful()
                ? ((i = e), (n = t))
                : ((n = e), (i = h.get.responseFromXHR(
                    n
                  ))), h.remove.loading(), v.onComplete.call(P, i, T, n);
            },
            fail: function(e, t, n) {
              ...
              return 'aborted' == t
                ...
                : ('invalid' == t
                    ...
                    : 'error' == t &&
                        e !== i &&
                        (h.debug('XHR produced a server error', t, n), 200 !=
                          e.status &&
                          n !== i &&
                          '' !== n &&
                          h.error(C.statusMessage + n, a.url), v.onError.call(
                          P,
                          r,
                          T,
                          e
                    ...
                    (h.debug(
                      'Adding error state'
                    ), h.set.error(), h.should.removeError() &&
                      setTimeout(h.remove.error, v.errorDuration)), h.debug(
                    'API Request failed',
                    r,
                    e
        ...
        create: {
            ...
            return (i = e
              ...
              ? (e.isFunction(s)
                  ...
                  : (h.debug(
                      ...
                      s
                    ), (n = s)), i.resolveWith(P, [n, o, { responseText: n }]))
              : e.isFunction(l) &&
                  ((t = function(e) {
                    h.debug('Async callback returned response', e), e
          ...
          xhr: function() {
            ...
            return (t = e
              ...
              .done(h.event.xhr.done)
              .fail(h.event.xhr.fail)), h.verbose(
        ...
        set: {
          ...
          loading: function() {
            h.verbose('Adding loading state to element', R), R.addClass(
              w.loading
            ), (p = new Date().getTime());
          }
        },
        remove: {
          error: function() {
            h.verbose('Removing error state from element', R), R.removeClass(
              w.error
            );
          },
          loading: function() {
            h.verbose('Removing loading state from element', R), R.removeClass(
              w.loading
            );
          }
        },
        get: {
          ...
          settings: function() {
            var t;
            return (t = v.beforeSend.call(P, v)), t &&
              (t.success !== i &&
                (h.debug('Legacy success callback detected', t), h.error(
                  C.legacyParameters,
                  t.success
                ), (t.onSuccess = t.success)), t.failure !== i &&
                (h.debug('Legacy failure callback detected', t), h.error(
                  C.legacyParameters,
                  t.failure
                ), (t.onFailure = t.failure)), t.complete !== i &&
                (h.debug('Legacy complete callback detected', t), h.error(
                  C.legacyParameters,
                  t.complete
                ), (t.onComplete = t.complete))), t === i &&
              h.error(C.noReturnedValue), t === !1
              ? t
                  ...
                  ? T.is('input')
                      ? E.oninput !== i
                          ...
                          : E.onpropertychange !== i
                              ? 'propertychange'
                              : 'keyup'
                      : T.is('form') ? 'submit' : 'click'
                  : v.on;
          },
          templatedURL: function(e) {
            if (
              ((e = e || T.data(y.action) || v.action || !1), (m = T.data(
                y.url
              ) ||
                v.url ||
                !1))
            ...
            if (e) {
              if (
                (h.debug('Looking up url for action', e, v.api), v.api[e] ===
                  i && !h.is.mocked())
              )
              ...
              h.is.form() &&
                ((m = T.attr('action') || R.attr('action') || !1), h.debug(
        ...
        invoke: function(t, n, a) {
          var r, s, l, c = F;
          return (n = n || d), (a = E || a), 'string' == typeof t &&
            c !== i &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(n, o) {
              var a = n != r
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    return a.each(function() {
      ...
      (n = {
        initialize: function() {
          n.verbose('Initializing module'), f.automatic &&
            n.add.defaults(), f.context && '' !== r
            ? e(f.context)
            ...
            : C.on('mouseenter' + y, n.change.text)
                ...
                .on('click' + y, n.toggle.state), n.instantiate();
        },
        instantiate: function() {
        ...
        add: {
          defaults: function() {
            ...
            e.each(f.defaults, function(t, a) {
              n.is[t] !== i &&
                n.is[t]() &&
                (n.verbose('Adding default states', t, w), e.extend(
                  f.states,
                  a,
                  o
                ));
        ...
        listenTo: function(t) {
          n.debug('API request detected, waiting for state signal', t), t &&
            (b.loading && n.update.text(b.loading), e.when(t).then(function() {
              'resolved' == t.state()
                ? (n.debug(
        ...
        change: {
          state: function() {
            n.debug('Determining state change direction'), n.is.inactive()
              ? n.activate()
              : n.deactivate(), f.sync && n.sync(), f.onChange.call(w);
          },
          text: function() {
            n.is.textEnabled() &&
              (n.is.disabled()
        ...
        activate: function() {
          f.activateTest.call(w) &&
            (n.debug('Setting state to active'), C.addClass(
              p.active
            ), n.update.text(b.active), f.onActivate.call(w));
        },
        deactivate: function() {
          f.deactivateTest.call(w) &&
            (n.debug('Setting state to inactive'), C.removeClass(
              p.active
            ), n.update.text(b.inactive), f.onDeactivate.call(w));
        },
        sync: function() {
        ...
        flash: {
          text: function(e, t, i) {
            var o = n.get.text();
            n.debug('Flashing text message', e, t), (e = e ||
              f.text.flash), (t = t || f.flashDuration), (i = i ||
              function() {}), n.update.text(e), setTimeout(
              function() {
          ...
          text: function() {
            ...
            n.is.textEnabled() &&
              (n.is.active() && e
                ...
                : t &&
                    (n.verbose('Resetting inactive text', e), n.update.text(
                      t
                    )));
          }
        },
        update: {
          text: function(e) {
            var t = n.get.text();
            e && e !== t
              ? (n.debug('Updating text', e), f.selector.text
        ...
        invoke: function(t, a, r) {
          var s, l, c, u = k;
          return (a = a || d), (r = w || r), 'string' == typeof t &&
            u !== i &&
            ((t = t.split(/[\. ]/)), (s = t.length -
              1), e.each(t, function(o, a) {
              var r = o != s
                ? a + t[o + 1].charAt(0).toUpperCase() + t[o + 1].slice(1)
                : t;
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    : 'undefined' != typeof self && self.Math == Math
        ? self
        : Function('return this')()), (e.fn.visibility = function(o) {
    var a,
      r = e(this),
      s = r.selector || '',
      l = new Date().getTime(),
      ...
      (v = {
        initialize: function() {
          v.debug(
            'Initializing',
            b
          ), v.setup.cache(), v.should.trackChanges() &&
            ('image' == b.type && v.setup.image(), 'fixed' == b.type &&
              v.setup.fixed(), b.observeChanges &&
              v.observeChanges(), v.bind.events()), v.save.position(), v.is.visible() ||
            v.error(C.visible, A), b.initialCheck &&
            v.checkVisibility(), v.instantiate();
        },
        instantiate: function() {
          v.debug('Storing instance', v), A.data(S, v), (E = v);
        },
        destroy: function() {
          v.verbose('Destroying previous module'), h && h.disconnect(), p &&
            p.disconnect(), T.off('load' + k, v.event.load).off(
            'resize' + k,
            v.event.resize
            ...
            (v.resetFixed(), v.remove.placeholder()), A.off(k).removeData(S);
        },
        observeChanges: function() {
          'MutationObserver' in t &&
            ((p = new MutationObserver(
              v.event.contextChanged
            )), (h = new MutationObserver(v.event.changed)), p.observe(n, {
              childList: !0,
              subtree: !0
            }), h.observe(F, { childList: !0, subtree: !0 }), v.debug(
              'Setting up mutation observer',
              h
            ));
        },
        bind: {
          events: function() {
            ...
            ), b.refreshOnLoad && T.on('load' + k, v.event.load), T.on(
              'resize' + k,
              v.event.resize
            ), R.off('scroll' + k)
        ...
        event: {
          ...
          scroll: function() {
            b.throttle
              ? (clearTimeout(v.timer), (v.timer = setTimeout(
                  function() {
        ...
        setup: {
          ...
          image: function() {
            ...
            e &&
              (v.verbose(
                'Lazy loading image',
                e
              ), (b.once = !0), (b.observeChanges = !1), (b.onOnScreen = function() {
                v.debug('Image on screen', F), v.precache(e, function() {
                  v.set.image(e, function() {
                    g++, g == m &&
                      b.onAllLoaded.call(this), b.onLoad.call(this);
                  });
                });
              }));
          },
          fixed: function() {
            v.debug(
              'Setting up fixed'
            ), (b.once = !1), (b.observeChanges = !1), (b.initialCheck = !0), (b.refreshOnLoad = !0), o.transition ||
              (b.transition = !1), v.create.placeholder(), v.debug(
              'Added placeholder',
              r
              ...
              v.debug(
                ...
                A
              ), v.show.placeholder(), v.set.fixed(), b.transition &&
                e.fn.transition !== i &&
              ...
              v.debug(
                ...
                A
              ), v.hide.placeholder(), v.remove.fixed();
            });
          }
        },
        create: {
          placeholder: function() {
            v.verbose('Creating fixed position placeholder'), (r = A.clone(!1)
              .css('display', 'none')
        ...
        show: {
          placeholder: function() {
            v.verbose('Showing placeholder'), r
              .css('display', 'block')
        ...
        hide: {
          placeholder: function() {
            v.verbose('Hiding placeholder'), r
              .css('display', 'none')
              .css('visibility', '');
          }
        },
        set: {
          fixed: function() {
            v.verbose('Setting element to fixed position'), A.addClass(
              y.fixed
            ).css({
              position: 'fixed',
              top: b.offset + 'px',
        ...
        refresh: function() {
          v.debug('Refreshing constants (width/height)'), 'fixed' == b.type &&
            v.resetFixed(), v.reset(), v.save.position(), b.checkOnRefresh &&
            v.checkVisibility(), b.onRefresh.call(F);
        },
        resetFixed: function() {
          v.remove.fixed(), v.remove.occurred();
        },
        reset: function() {
          v.verbose('Resetting all cached values'), e.isPlainObject(v.cache) &&
            ((v.cache.screen = {}), (v.cache.element = {}));
        },
        checkVisibility: function(e) {
          v.verbose('Checking visibility of element', v.cache.element), !O &&
            v.is.visible() &&
            (v.save.scroll(
              e
            ), v.save.calculations(), v.passed(), v.passingReverse(), v.topVisibleReverse(), v.bottomVisibleReverse(), v.topPassedReverse(), v.bottomPassedReverse(), v.onScreen(), v.offScreen(), v.passing(), v.topVisible(), v.bottomVisible(), v.topPassed(), v.bottomPassed(), b.onUpdate &&
          ...
          if (
            (e &&
              (v.debug(
                ...
                e
              ), (b.onOnScreen = e)), t.onScreen
              ? v.execute(n, o)
              : b.once || v.remove.occurred(o), e !== i)
          )
            return t.onOnScreen;
        },
          ...
          if (
            (e &&
              (v.debug(
                ...
                e
              ), (b.onBottomVisible = e)), t.bottomVisible
              ? v.execute(n, o)
              : b.once || v.remove.occurred(o), e === i)
          )
          ...
          if (
            (e &&
              (v.debug(
                ...
                e
              ), (b.onBottomPassed = e)), t.bottomPassed
              ? v.execute(n, o)
              : b.once || v.remove.occurred(o), e === i)
          )
          ...
          if (
            (e &&
              (v.debug(
                ...
                e
              ), (b.onPassingReverse = e)), t.passing
              ? b.once || v.remove.occurred(o)
              : v.get.occurred('passing') && v.execute(n, o), e !== i)
          )
            return !t.passing;
        },
          ...
          if (
            (e &&
              (v.debug(
                ...
                e
              ), (b.onTopVisibleReverse = e)), t.topVisible
              ? b.once || v.remove.occurred(o)
              : v.get.occurred('topVisible') && v.execute(n, o), e === i)
          )
            return !t.topVisible;
        },
          ...
          if (
            (e &&
              (v.debug(
                ...
                e
              ), (b.onBottomVisibleReverse = e)), t.bottomVisible
              ? b.once || v.remove.occurred(o)
              : v.get.occurred('bottomVisible') && v.execute(n, o), e === i)
          )
            return !t.bottomVisible;
        },
          ...
          if (
            (e &&
              (v.debug(
                ...
                e
              ), (b.onTopPassedReverse = e)), t.topPassed
              ? b.once || v.remove.occurred(o)
              : v.get.occurred('topPassed') && v.execute(n, o), e === i)
          )
          ...
          if (
            (e &&
              (v.debug(
                ...
                e
              ), (b.onBottomPassedReverse = e)), t.bottomPassed
              ? b.once || v.remove.occurred(o)
              : v.get.occurred('bottomPassed') && v.execute(n, o), e === i)
          )
            return !t.bottomPassed;
        },
        execute: function(e, t) {
          ...
          (e = e || !1), e &&
            (b.continuous
              ? (v.debug('Callback being called continuously', t, n), e.call(
                  F,
                  n,
                  i
                ))
              : v.get.occurred(t) ||
                  (v.debug('Conditions met', t, n), e.call(
                    F,
                    n,
                    i
                  ))), v.save.occurred(t);
        ...
        save: {
          calculations: function() {
            ...
            ), v.save.direction(), v.save.screenCalculations(), v.save.elementCalculations();
          },
          occurred: function(e) {
            e &&
              ((v.cache.occurred[e] !== i && v.cache.occurred[e] === !0) ||
                (v.verbose('Saving callback occurred', e), (v.cache.occurred[
                  e
                ] = !0)));
          },
          scroll: function(e) {
            (e = e + b.offset ||
              R.scrollTop() + b.offset), (v.cache.scroll = e);
          },
          direction: function() {
            ...
            return (e = t > n && n
              ...
              : t < n && n
                  ? 'up'
                  : 'static'), (v.cache.direction = e), v.cache.direction;
          },
          elementPosition: function() {
            var e = v.cache.element, t = v.get.screenSize();
            return v.verbose('Saving element position'), (e.fits = e.height <
              t.height), (e.offset = A.offset()), (e.width = A.outerWidth()), (e.height = A.outerHeight()), (v.cache.element = e), e;
          },
          elementCalculations: function() {
            var e = v.get.screenCalculations(), t = v.get.elementPosition();
            return b.includeMargin
              ? ((t.margin = {}), (t.margin.top = parseInt(
                  A.css('margin-top'),
                  10
                  ...
                  t.margin.top), (t.bottom = t.offset.top +
                  t.height +
                  t.margin.bottom))
              : ((t.top = t.offset.top), (t.bottom = t.offset.top +
                  t.height)), (t.topVisible = e.bottom >=
              t.top), (t.topPassed = e.top >=
              t.top), (t.bottomVisible = e.bottom >=
              t.bottom), (t.bottomPassed = e.top >=
              t.bottom), (t.pixelsPassed = 0), (t.percentagePassed = 0), (t.onScreen = t.topVisible &&
              !t.bottomPassed), (t.passing = t.topPassed &&
              !t.bottomPassed), (t.offScreen = !t.onScreen), t.passing &&
              ((t.pixelsPassed = e.top - t.top), (t.percentagePassed = (e.top -
                t.top) /
                t.height)), (v.cache.element = t), v.verbose(
          ...
          screenCalculations: function() {
            var e = v.get.scroll();
            return v.save.direction(), (v.cache.screen.top = e), (v.cache.screen.bottom = e +
              v.cache.screen.height), v.cache.screen;
          },
          screenSize: function() {
        ...
        get: {
          ...
          direction: function() {
            return v.cache.direction === i &&
              v.save.direction(), v.cache.direction;
          },
          elementPosition: function() {
            return v.cache.element === i &&
              v.save.elementPosition(), v.cache.element;
          },
          elementCalculations: function() {
            return v.cache.element === i &&
              v.save.elementCalculations(), v.cache.element;
          },
          screenCalculations: function() {
            return v.cache.screen === i &&
              v.save.screenCalculations(), v.cache.screen;
          },
          screenSize: function() {
