      ...
      (f = {
        ...
        destroy: function() {
          f.verbose(
            ...
            u
          ), f.unbind.events(), f.remove.variation(), l.off(y);
        },
        bind: {
          events: function() {
            'hover' == g.on
              ? l.on('mouseenter' + y, f.show).on('mouseleave' + y, f.hide)
              : 'click' == g.on && l.on(S + y, f.toggle), f.is.page() &&
              (f.debug(
                'Setting as a page dimmer',
                l
              ), f.set.pageDimmer()), f.is.closable() &&
              (f.verbose('Adding dimmer close event', u), l.on(
                S + y,
                p.dimmer,
                f.event.click
              ));
        ...
        event: {
          click: function(i) {
            f.verbose('Determining if event occured on dimmer', i), (0 ===
              u.find(i.target).length ||
        ...
        create: function() {
          ...
          return g.dimmerName &&
            (f.debug('Creating named dimmer', g.dimmerName), i.addClass(
              g.dimmerName
            )), i.appendTo(l), i;
        },
        show: function(i) {
          (i = e.isFunction(i) ? i : function() {}), f.debug(
            'Showing dimmer',
            u,
            g
        ...
        hide: function(i) {
          (i = e.isFunction(i) ? i : function() {}), f.is.dimmed() ||
            f.is.animating()
            ? (f.debug('Hiding dimmer', u), f.animate.hide(i), g.onHide.call(
                T
              ), g.onChange.call(T))
        ...
        animate: {
          show: function(i) {
            (i = e.isFunction(i) ? i : function() {}), g.useCSS &&
              e.fn.transition !== t &&
              u.transition('is supported')
              ? ('auto' !== g.opacity && f.set.opacity(), u.transition({
          ...
          hide: function(i) {
            (i = e.isFunction(i) ? i : function() {}), g.useCSS &&
              ...
              : (f.verbose(
                  ...
                  .stop()
                  .fadeOut(f.get.duration(), function() {
        ...
        set: {
          opacity: function(e) {
            var i = u.css('background-color'),
              ...
              t = n && 3 == n.length,
              o = n && 4 == n.length;
            (e = 0 === g.opacity ? 0 : g.opacity || e), t || o
              ? ((n[3] = e + ')'), (i = n.join(',')))
              : (i = 'rgba(0, 0, 0, ' + e + ')'), f.debug(
              'Setting opacity to',
              e
        ...
        performance: {
          ...
          display: function() {
            ...
            (r = !1), clearTimeout(
              ...
              n += i['Execution Time'];
            }), (i += ' ' + n + 'ms'), w && (i += " '" + w + "'"), a.length >
              1 && (i += ' (' + a.length + ')'), (console.group !== t ||
              console.table !== t) &&
              s.length > 0 &&
        ...
        invoke: function(i, n, a) {
          var r, s, m, d = N;
          return (n = n || c), (a = T || a), 'string' == typeof i &&
            d !== t &&
            ((i = i.split(/[\. ]/)), (r = i.length -
