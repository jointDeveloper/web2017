            ...
            keydown: function(event) {
              ...
              if (isShortcutKey) {
                ...
                if (pressedKey == keys.leftArrow) {
                  ...
                  pressedKey == keys.deleteKey || pressedKey == keys.backspace
                ) {
                  if (hasActiveLabel) {
        ...
        get: {
          ...
          value: function() {
            var value = $input.length > 0
              ...
              isEmptyMultiselect = $.isArray(value) &&
                value.length === 1 &&
                value[0] === '';
            ...
            if (shouldSearch) {
              $item.each(function() {
                ...
                if (isMultiple) {
                  ...
                  if (
                    String(optionValue) == String(value) || optionText == value
                  ) {
                    module.verbose(
          ...
          if (typeof query == 'string' && object !== undefined) {
            ...
            $.each(query, function(depth, value) {
              var camelCaseValue = depth != maxDepth
                ...
                : query;
              if (
                $.isPlainObject(object[camelCaseValue]) && depth != maxDepth
              ) {
