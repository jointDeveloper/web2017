...
!(function(n, e, i, t) {
  ...
  (e = 'undefined' != typeof e && e.Math == Math
    ...
    return o.each(function(e) {
      ...
      (C = {
        initialize: function() {
          (f = C.get.settings.apply(
            S,
            u
          )), (v = f.className), (g = f.error), (b = f.metadata), (w = '.' +
            f.namespace), (h = 'module-' + f.namespace), (p = A.data(h) ||
            C), (y = C.get.animationEndEvent()), m && (m = C.invoke(d)), m ===
            !1 &&
            (C.verbose(
              'Converted arguments into settings object',
              f
            ), f.interval ? C.delay(f.animate) : C.animate(), C.instantiate());
        },
        ...
        delay: function(n) {
          ...
          r ||
            (r = C.can.transition() ? C.get.direction() : 'static'), (n = n !==
            t
            ? n
            : f.interval), (i = 'auto' == f.reverse &&
            r == v.outward), (a = i || 1 == f.reverse
            ? (o.length - e) * f.interval
            : e * f.interval), C.debug('Delaying animation by', a), setTimeout(
            C.animate,
            a
          );
        },
        ...
        queue: function(n) {
          C.debug('Queueing animation of', n), (C.queuing = !0), A.one(
            y + '.queue' + w,
            function() {
            ...
            (C.is.outward()
              ...
              : C.is.inward()
                  ...
                  : (C.verbose(
                    ...
                    ), C.restore.conditions(), f.onComplete.call(S)));
        },
        force: {
          visible: function() {
            var n = A.attr('style'),
          ...
          hidden: function() {
            ...
            'none' === e || C.is.hidden()
              ...
              : (C.verbose('Overriding default display to hide element'), A.css(
                  'display',
                  'none'
                ));
          }
        ...
        has: {
          direction: function(e) {
            var i = !1;
            return (e = e || f.animation), 'string' == typeof e &&
              ((e = e.split(' ')), n.each(e, function(n, e) {
        ...
        set: {
          animating: function(n) {
            var e;
            C.remove.completeCallback(), (n = n ||
              f.animation), (e = C.get.animationClass(n)), C.save.animation(
              e
          ...
          duration: function(n, e) {
            (e = e || f.duration), (e = 'number' == typeof e
              ? e + 'ms'
              : e), (e || 0 === e) &&
              (C.verbose('Setting animation duration', e), A.css({
                'animation-duration': e
              }));
          },
          direction: function(n) {
            (n = n || C.get.direction()), n == v.inward
              ? C.set.inward()
              : C.set.outward();
          },
          looping: function() {
          ...
          inward: function() {
            C.debug('Setting direction to inward'), A.removeClass(
              v.outward
            ).addClass(v.inward);
          },
          outward: function() {
            C.debug('Setting direction to outward'), A.removeClass(
              v.inward
            ).addClass(v.outward);
          },
          visible: function() {
        ...
        start: {
          animation: function(n) {
            (n = n || C.get.animationClass()), C.debug(
              'Starting tween',
              n
            ), A.addClass(n).one(
              y + '.complete' + w,
              C.complete
            ), f.useFailSafe && C.add.failSafe(), C.set.duration(
              f.duration
            ), f.onStart.call(S);
          }
        },
        save: {
          ...
          transitionExists: function(e, i) {
            (n.fn.transition.exists[e] = i), C.verbose(
        ...
        remove: {
          ...
          looping: function() {
            C.debug('Transitions are no longer looping'), C.is.looping() &&
              (C.reset(), A.removeClass(v.looping));
          },
          transition: function() {
        ...
        get: {
          ...
          animationClass: function(n) {
            var e = n || f.animation,
              i = C.can.transition() && !C.has.direction()
                ? C.get.direction() + ' '
                : '';
          ...
          duration: function(n) {
            return (n = n || f.duration), n === !1 &&
              (n = A.css('animation-duration') || 0), 'string' == typeof n
              ? n.indexOf('ms') > -1 ? parseFloat(n) : 1e3 * parseFloat(n)
              : n;
          },
          displayType: function(n) {
            return (n = n === t || n), f.displayType
              ? f.displayType
              : (n &&
                  A.data(b.displayType) === t &&
                  C.can.transition(!0), A.data(b.displayType));
          },
          userStyle: function(n) {
            return (n = n || A.attr('style') || ''), n.replace(
              /display.*?;/,
              ''
            );
          },
        ...
        can: {
          transition: function(e) {
            ...
            if (d === t || e) {
              if (
                (C.verbose('Determining whether animation exists'), (i = A.attr(
                  'class'
                )), (a = A.prop('tagName')), (o = n('<' + a + ' />')
                  .addClass(i)
                  .insertAfter(A)), (r = o
                  .addClass(u)
                  ...
                  ((c = o
                    ...
                    c
                  ), C.save.displayType(c)), o.remove(), r != s)
              )
        ...
        is: {
          ...
          occurring: function(n) {
            return (n = n || f.animation), (n = '.' +
              n.replace(' ', '.')), A.filter(n).length > 0;
          },
          visible: function() {
            return A.is(':visible');
          },
        ...
        hide: function() {
          C.verbose('Hiding element'), C.is.animating() &&
            C.reset(), S.blur(), C.remove.display(), C.remove.visible(), C.set.hidden(), C.force.hidden(), f.onHide.call(
            S
          ), f.onComplete.call(S);
        },
        show: function(n) {
          C.verbose(
            'Showing element',
            n
          ), C.remove.hidden(), C.set.visible(), C.force.visible(), f.onShow.call(
            S
          ), f.onComplete.call(S);
        },
        toggle: function() {
        ...
        stopAll: function() {
          ...
          ), C.remove.queueCallback(), A.triggerHandler(y);
        },
        clear: {
          queue: function() {
        ...
        performance: {
          ...
          display: function() {
            ...
            (s = !1), clearTimeout(
              ...
              i += e['Execution Time'];
            }), (e += ' ' + i + 'ms'), r && (e += " '" + r + "'"), o.length >
              1 && (e += ' (' + o.length + ')'), (console.group !== t ||
              console.table !== t) &&
              l.length > 0 &&
        ...
        invoke: function(e, i, o) {
          var r, s, l, u = p;
          return (i = i || c), (o = S || o), 'string' == typeof e &&
            u !== t &&
            ((e = e.split(/[\. ]/)), (r = e.length -
              1), n.each(e, function(i, a) {
              var o = i != r
                ? a + e[i + 1].charAt(0).toUpperCase() + e[i + 1].slice(1)
                : e;
