...
!(function(e, t, o, n) {
  ...
  (t = 'undefined' != typeof t && t.Math == Math
    ...
    return r.each(function() {
      ...
      (p = {
        initialize: function() {
          p.determineContainer(), p.determineContext(), p.verbose(
            'Initializing sticky',
            b,
            r
          ), p.save.positions(), p.checkErrors(), p.bind.events(), b.observeChanges &&
            p.observeChanges(), p.instantiate();
        },
        instantiate: function() {
          p.verbose('Storing instance of module', p), (z = p), k.data(y, p);
        },
        destroy: function() {
          p.verbose('Destroying previous instance'), p.reset(), h &&
            h.disconnect(), g && g.disconnect(), T.off(
            'load' + S,
            p.event.load
          ).off('resize' + S, p.event.resize), w.off(
            'scrollchange' + S,
        ...
        observeChanges: function() {
          'MutationObserver' in t &&
            ((h = new MutationObserver(
              p.event.documentChanged
            )), (g = new MutationObserver(p.event.changed)), h.observe(o, {
              childList: !0,
              subtree: !0
        ...
        checkErrors: function() {
          if (
            (p.is.hidden() && p.error(C.visible, k), p.cache.element.height >
        ...
        event: {
          changed: function(e) {
            clearTimeout(p.timer), (p.timer = setTimeout(
              function() {
                p.verbose(
        ...
        refresh: function(e) {
          p.reset(), b.context || p.determineContext(), e &&
            p.determineContainer(), p.save.positions(), p.stick(), b.onReposition.call(
            P
          );
        },
        supports: {
        ...
        save: {
          ...
          positions: function() {
            ...
            p.is.standardScroll() ||
              ...
              ), (e.top = w.scrollTop()), (e.left = w.scrollLeft()), (t.offset.top += e.top), (o.offset.top += e.top), (t.offset.left += e.left), (o.offset.left += e.left)), (p.cache = {
            ...
            }), p.set.containerSize(), p.set.size(), p.stick(), p.debug(
        ...
        get: {
          direction: function(e) {
            var t = 'down';
            return (e = e || w.scrollTop()), p.lastScroll !== n &&
              (p.lastScroll < e
                ? (t = 'down')
                : p.lastScroll > e && (t = 'up')), t;
          },
          scrollChange: function(e) {
            return (e = e || w.scrollTop()), p.lastScroll
              ? e - p.lastScroll
              : 0;
          },
        ...
        set: {
          offset: function() {
            p.verbose('Setting offset on element', b.offset), k.css(
              'margin-top',
              b.offset
            );
          },
          containerSize: function() {
            ...
            'HTML' === e || 'body' == e
              ...
              : Math.abs(r.outerHeight() - p.cache.context.height) > b.jitter &&
                  (p.debug(
          ...
          scroll: function(e) {
            p.debug('Setting scroll on element', e), p.elementScroll != e &&
              (p.is.top() &&
                k.css('bottom', '').css('top', -e), p.is.bottom() &&
        ...
        fixTop: function() {
          ...
          ), p.set.minimumSize(), p.set.offset(), k
        ...
        unfix: function() {
          p.is.fixed() &&
            (p.debug(
              ...
              .removeClass(v.fixed)
              .removeClass(v.top)
              .removeClass(v.bottom), b.onUnstick.call(P));
        },
        reset: function() {
          p.debug(
            'Resetting elements position'
          ), p.unbind(), p.unfix(), p.resetCSS(), p.remove.offset(), p.remove.lastScroll();
        },
        resetCSS: function() {
        ...
        invoke: function(t, o, i) {
          var r, c, l, a = z;
          return (o = o || u), (i = P || i), 'string' == typeof t &&
            a !== n &&
            ((t = t.split(/[\. ]/)), (r = t.length -
              1), e.each(t, function(o, i) {
              var s = o != r
                ? i + t[o + 1].charAt(0).toUpperCase() + t[o + 1].slice(1)
                : t;
              if (e.isPlainObject(a[s]) && o != r)
                a = a[s];
              else {
